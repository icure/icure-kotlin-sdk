...
------------ | ------------- | ------------- | -------------
**id** | **kotlin.String** | the Id of the form. We encourage using either a v4 UUID or a HL7 Id. |
...
**rev** | **kotlin.String** | the revision of the form in the database, used for conflict management / optimistic locking. |  [optional]
...
**logicalUuid** | **kotlin.String** |  |  [optional]
**descr** | **kotlin.String** | Name/basic description of the form |  [optional]
**uniqueId** | **kotlin.String** | A unique external id (from another external source). |  [optional]
**formTemplateId** | **kotlin.String** | Id of the form template being used to display the form |  [optional]
**contactId** | **kotlin.String** | Id of the contact for which the form is being used. |  [optional]
**healthElementId** | **kotlin.String** | The healthcare element to which this form is attached. |  [optional]
**planOfActionId** | **kotlin.String** | The healthcare approach to which this form is attached. |  [optional]
**parent** | **kotlin.String** | The parent of this form, used to determine the forms hierarchy |  [optional]
