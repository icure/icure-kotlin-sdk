...
<a name="generateMedicationSchemeExport12"></a>
...
<a name="generateMedicationSchemeExport15"></a>
...
<a name="generateSumehrV27"></a>
# **generateSumehrV27**
> kotlin.Any generateSumehrV27(UNKNOWN_PARAMETER_NAME, inlineObject27)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#generateSumehrV27")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#generateSumehrV27")
    e.printStackTrace()
}
```
...
<a name="generateSumehrV28"></a>
# **generateSumehrV28**
> kotlin.Any generateSumehrV28(UNKNOWN_PARAMETER_NAME, inlineObject25)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#generateSumehrV28")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#generateSumehrV28")
    e.printStackTrace()
}
```
...
<a name="generateSumehrV29"></a>
# **generateSumehrV29**
> kotlin.Any generateSumehrV29(UNKNOWN_PARAMETER_NAME, inlineObject72)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#generateSumehrV29")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#generateSumehrV29")
    e.printStackTrace()
}
```
...
<a name="generateSumehrV2JSON"></a>
# **generateSumehrV2JSON**
> kotlin.Any generateSumehrV2JSON(UNKNOWN_PARAMETER_NAME, asJson, inlineObject30)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#generateSumehrV2JSON")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#generateSumehrV2JSON")
    e.printStackTrace()
}
```
...
------------- | ------------- | ------------- | -------------
 **UNKNOWN_PARAMETER_NAME** | [****](.md)|  |
 **asJson** | **kotlin.Boolean**|  | [optional]
...
<a name="generateSumehrV2JSON1"></a>
# **generateSumehrV2JSON1**
> kotlin.Any generateSumehrV2JSON1(UNKNOWN_PARAMETER_NAME, asJson, inlineObject28)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#generateSumehrV2JSON1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#generateSumehrV2JSON1")
    e.printStackTrace()
}
```
...
<a name="generateSumehrV2JSON10"></a>
# **generateSumehrV2JSON10**
> kotlin.Any generateSumehrV2JSON10(patientId, language, info, UNKNOWN_PARAMETER_NAME, asJson)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#generateSumehrV2JSON10")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#generateSumehrV2JSON10")
    e.printStackTrace()
}
```
...
<a name="generateSumehrV2JSON11"></a>
# **generateSumehrV2JSON11**
> kotlin.Any generateSumehrV2JSON11(UNKNOWN_PARAMETER_NAME, asJson, inlineObject80)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#generateSumehrV2JSON11")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#generateSumehrV2JSON11")
    e.printStackTrace()
}
```
...
<a name="generateSumehrV2JSON12"></a>
# **generateSumehrV2JSON12**
> kotlin.Any generateSumehrV2JSON12(UNKNOWN_PARAMETER_NAME, asJson, inlineObject81)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#generateSumehrV2JSON12")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#generateSumehrV2JSON12")
    e.printStackTrace()
}
```
...
<a name="generateSumehrV2JSON13"></a>
# **generateSumehrV2JSON13**
> kotlin.Any generateSumehrV2JSON13(UNKNOWN_PARAMETER_NAME, asJson, inlineObject79)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#generateSumehrV2JSON13")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#generateSumehrV2JSON13")
    e.printStackTrace()
}
```
...
<a name="generateSumehrV2JSON2"></a>
# **generateSumehrV2JSON2**
> kotlin.Any generateSumehrV2JSON2(UNKNOWN_PARAMETER_NAME, asJson, inlineObject29)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#generateSumehrV2JSON2")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#generateSumehrV2JSON2")
    e.printStackTrace()
}
```
...
<a name="generateSumehrV2JSON3"></a>
# **generateSumehrV2JSON3**
> kotlin.Any generateSumehrV2JSON3(patientId, language, info, UNKNOWN_PARAMETER_NAME, asJson)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#generateSumehrV2JSON3")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#generateSumehrV2JSON3")
    e.printStackTrace()
}
```
...
<a name="generateSumehrV2JSON4"></a>
# **generateSumehrV2JSON4**
> kotlin.Any generateSumehrV2JSON4(UNKNOWN_PARAMETER_NAME, asJson, inlineObject32)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#generateSumehrV2JSON4")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#generateSumehrV2JSON4")
    e.printStackTrace()
}
```
...
<a name="generateSumehrV2JSON5"></a>
# **generateSumehrV2JSON5**
> kotlin.Any generateSumehrV2JSON5(UNKNOWN_PARAMETER_NAME, asJson, inlineObject33)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#generateSumehrV2JSON5")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#generateSumehrV2JSON5")
    e.printStackTrace()
}
```
...
<a name="generateSumehrV2JSON6"></a>
# **generateSumehrV2JSON6**
> kotlin.Any generateSumehrV2JSON6(UNKNOWN_PARAMETER_NAME, asJson, inlineObject31)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#generateSumehrV2JSON6")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#generateSumehrV2JSON6")
    e.printStackTrace()
}
```
...
<a name="generateSumehrV2JSON7"></a>
# **generateSumehrV2JSON7**
> kotlin.Any generateSumehrV2JSON7(UNKNOWN_PARAMETER_NAME, asJson, inlineObject78)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#generateSumehrV2JSON7")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#generateSumehrV2JSON7")
    e.printStackTrace()
}
```
...
<a name="generateSumehrV2JSON8"></a>
# **generateSumehrV2JSON8**
> kotlin.Any generateSumehrV2JSON8(UNKNOWN_PARAMETER_NAME, asJson, inlineObject76)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#generateSumehrV2JSON8")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#generateSumehrV2JSON8")
    e.printStackTrace()
}
```
...
<a name="generateSumehrV2JSON9"></a>
# **generateSumehrV2JSON9**
> kotlin.Any generateSumehrV2JSON9(UNKNOWN_PARAMETER_NAME, asJson, inlineObject77)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#generateSumehrV2JSON9")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#generateSumehrV2JSON9")
    e.printStackTrace()
}
```
...
<a name="validateSumehr10"></a>
# **validateSumehr10**
> kotlin.Any validateSumehr10(UNKNOWN_PARAMETER_NAME, inlineObject52)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehr10")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehr10")
    e.printStackTrace()
}
```
...
<a name="validateSumehr11"></a>
# **validateSumehr11**
> kotlin.Any validateSumehr11(UNKNOWN_PARAMETER_NAME, inlineObject53)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehr11")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehr11")
    e.printStackTrace()
}
```
...
<a name="validateSumehr12"></a>
# **validateSumehr12**
> kotlin.Any validateSumehr12(patientId, language, info, UNKNOWN_PARAMETER_NAME)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehr12")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehr12")
    e.printStackTrace()
}
```
...
<a name="validateSumehr13"></a>
# **validateSumehr13**
> kotlin.Any validateSumehr13(UNKNOWN_PARAMETER_NAME, inlineObject56)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehr13")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehr13")
    e.printStackTrace()
}
```
...
<a name="validateSumehr14"></a>
# **validateSumehr14**
> kotlin.Any validateSumehr14(UNKNOWN_PARAMETER_NAME, inlineObject57)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehr14")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehr14")
    e.printStackTrace()
}
```
...
<a name="validateSumehr15"></a>
# **validateSumehr15**
> kotlin.Any validateSumehr15(UNKNOWN_PARAMETER_NAME, inlineObject55)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehr15")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehr15")
    e.printStackTrace()
}
```
...
<a name="validateSumehr2"></a>
# **validateSumehr2**
> kotlin.Any validateSumehr2(UNKNOWN_PARAMETER_NAME, inlineObject6)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehr2")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehr2")
    e.printStackTrace()
}
```
...
<a name="validateSumehr3"></a>
# **validateSumehr3**
> kotlin.Any validateSumehr3(UNKNOWN_PARAMETER_NAME, inlineObject4)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehr3")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehr3")
    e.printStackTrace()
}
```
...
<a name="validateSumehr4"></a>
# **validateSumehr4**
> kotlin.Any validateSumehr4(UNKNOWN_PARAMETER_NAME, inlineObject5)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehr4")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehr4")
    e.printStackTrace()
}
```
...
<a name="validateSumehr5"></a>
# **validateSumehr5**
> kotlin.Any validateSumehr5(patientId, language, info, UNKNOWN_PARAMETER_NAME)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehr5")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehr5")
    e.printStackTrace()
}
```
...
<a name="validateSumehr6"></a>
# **validateSumehr6**
> kotlin.Any validateSumehr6(UNKNOWN_PARAMETER_NAME, inlineObject8)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehr6")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehr6")
    e.printStackTrace()
}
```
...
<a name="validateSumehr7"></a>
# **validateSumehr7**
> kotlin.Any validateSumehr7(UNKNOWN_PARAMETER_NAME, inlineObject9)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehr7")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehr7")
    e.printStackTrace()
}
```
...
<a name="validateSumehr8"></a>
# **validateSumehr8**
> kotlin.Any validateSumehr8(UNKNOWN_PARAMETER_NAME, inlineObject7)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehr8")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehr8")
    e.printStackTrace()
}
```
...
<a name="validateSumehr9"></a>
# **validateSumehr9**
> kotlin.Any validateSumehr9(UNKNOWN_PARAMETER_NAME, inlineObject54)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehr9")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehr9")
    e.printStackTrace()
}
```
...
<a name="validateSumehrV210"></a>
# **validateSumehrV210**
> kotlin.Any validateSumehrV210(UNKNOWN_PARAMETER_NAME, inlineObject58)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehrV210")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehrV210")
    e.printStackTrace()
}
```
...
<a name="validateSumehrV211"></a>
# **validateSumehrV211**
> kotlin.Any validateSumehrV211(UNKNOWN_PARAMETER_NAME, inlineObject59)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehrV211")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehrV211")
    e.printStackTrace()
}
```
...
<a name="validateSumehrV212"></a>
# **validateSumehrV212**
> kotlin.Any validateSumehrV212(patientId, language, info, UNKNOWN_PARAMETER_NAME)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehrV212")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehrV212")
    e.printStackTrace()
}
```
...
<a name="validateSumehrV213"></a>
# **validateSumehrV213**
> kotlin.Any validateSumehrV213(UNKNOWN_PARAMETER_NAME, inlineObject62)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehrV213")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehrV213")
    e.printStackTrace()
}
```
...
<a name="validateSumehrV214"></a>
# **validateSumehrV214**
> kotlin.Any validateSumehrV214(UNKNOWN_PARAMETER_NAME, inlineObject63)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehrV214")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehrV214")
    e.printStackTrace()
}
```
...
<a name="validateSumehrV215"></a>
# **validateSumehrV215**
> kotlin.Any validateSumehrV215(UNKNOWN_PARAMETER_NAME, inlineObject61)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehrV215")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehrV215")
    e.printStackTrace()
}
```
...
<a name="validateSumehrV22"></a>
# **validateSumehrV22**
> kotlin.Any validateSumehrV22(UNKNOWN_PARAMETER_NAME, inlineObject12)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehrV22")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehrV22")
    e.printStackTrace()
}
```
...
<a name="validateSumehrV23"></a>
# **validateSumehrV23**
> kotlin.Any validateSumehrV23(UNKNOWN_PARAMETER_NAME, inlineObject10)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehrV23")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehrV23")
    e.printStackTrace()
}
```
...
<a name="validateSumehrV24"></a>
# **validateSumehrV24**
> kotlin.Any validateSumehrV24(UNKNOWN_PARAMETER_NAME, inlineObject11)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehrV24")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehrV24")
    e.printStackTrace()
}
```
...
<a name="validateSumehrV25"></a>
# **validateSumehrV25**
> kotlin.Any validateSumehrV25(patientId, language, info, UNKNOWN_PARAMETER_NAME)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehrV25")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehrV25")
    e.printStackTrace()
}
```
...
<a name="validateSumehrV26"></a>
# **validateSumehrV26**
> kotlin.Any validateSumehrV26(UNKNOWN_PARAMETER_NAME, inlineObject14)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehrV26")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehrV26")
    e.printStackTrace()
}
```
...
<a name="validateSumehrV27"></a>
# **validateSumehrV27**
> kotlin.Any validateSumehrV27(UNKNOWN_PARAMETER_NAME, inlineObject15)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehrV27")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehrV27")
    e.printStackTrace()
}
```
...
<a name="validateSumehrV28"></a>
# **validateSumehrV28**
> kotlin.Any validateSumehrV28(UNKNOWN_PARAMETER_NAME, inlineObject13)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehrV28")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehrV28")
    e.printStackTrace()
}
```
...
<a name="validateSumehrV29"></a>
# **validateSumehrV29**
> kotlin.Any validateSumehrV29(UNKNOWN_PARAMETER_NAME, inlineObject60)
...
try {
    ...
    println("4xx response calling KmehrWsControllerApi#validateSumehrV29")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling KmehrWsControllerApi#validateSumehrV29")
    e.printStackTrace()
}
```
