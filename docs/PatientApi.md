...
[**countOfPatients1**](PatientApi.md#countOfPatients1) | **GET** /rest/v1/patient/hcParty/{hcPartyId}/count | Get count of patients for a specific HcParty or for the current HcParty 
[**createPatient**](PatientApi.md#createPatient) | **POST** /rest/v2/patient | Create a patient
[**createPatient1**](PatientApi.md#createPatient1) | **POST** /rest/v1/patient | Create a patient
...
[**filterPatientsBy1**](PatientApi.md#filterPatientsBy1) | **POST** /rest/v1/patient/filter | Filter patients for the current user (HcParty) 
...
[**findByExternalId**](PatientApi.md#findByExternalId) | **GET** /rest/v2/patient/byExternalId/{externalId} | Get the patient having the provided externalId
[**findByExternalId1**](PatientApi.md#findByExternalId1) | **GET** /rest/v1/patient/byExternalId/{externalId} | Get the patient having the provided externalId
...
[**fuzzySearch1**](PatientApi.md#fuzzySearch1) | **GET** /rest/v1/patient/fuzzy | Filter patients for the current user (HcParty) 
[**getPatient**](PatientApi.md#getPatient) | **GET** /rest/v2/patient/{patientId} | Get patient
[**getPatient1**](PatientApi.md#getPatient1) | **GET** /rest/v1/patient/{patientId} | Get patient
...
[**getPatientHcPartyKeysForDelegate1**](PatientApi.md#getPatientHcPartyKeysForDelegate1) | **GET** /rest/v1/patient/{patientId}/keys | Get the patient (identified by patientId) hcparty keys. Those keys are AES keys (encrypted) used to share information between HCPs and a patient.
[**getPatients**](PatientApi.md#getPatients) | **POST** /rest/v2/patient/byIds | Get patients by id
[**getPatients1**](PatientApi.md#getPatients1) | **POST** /rest/v1/patient/byIds | Get patients by id
...
[**listDeletedPatientsByName1**](PatientApi.md#listDeletedPatientsByName1) | **GET** /rest/v1/patient/deleted/by_name | Find deleted patients
...
[**listOfMergesAfter1**](PatientApi.md#listOfMergesAfter1) | **GET** /rest/v1/patient/merges/{date} | List patients that have been merged towards another patient 
...
[**matchPatientsBy1**](PatientApi.md#matchPatientsBy1) | **POST** /rest/v1/patient/match | Get ids of patients matching the provided filter for the current user (HcParty) 
...
[**mergeInto1**](PatientApi.md#mergeInto1) | **PUT** /rest/v1/patient/mergeInto/{toId}/from/{fromIds} | Merge a series of patients into another patient
[**modifyPatient**](PatientApi.md#modifyPatient) | **PUT** /rest/v2/patient | Modify a patient
[**modifyPatient1**](PatientApi.md#modifyPatient1) | **PUT** /rest/v1/patient | Modify a patient
...
[**modifyPatientReferral1**](PatientApi.md#modifyPatientReferral1) | **PUT** /rest/v1/patient/{patientId}/referral/{referralId} | Set a patient referral doctor
...
[**newPatientDelegations1**](PatientApi.md#newPatientDelegations1) | **POST** /rest/v1/patient/{patientId}/delegate | Delegates a patients to a healthcare party
...
[**undeletePatient1**](PatientApi.md#undeletePatient1) | **PUT** /rest/v1/patient/undelete/{patientIds} | undelete previously deleted patients
...
<a name="countOfPatients1"></a>
# **countOfPatients1**
> ContentDto countOfPatients1(hcPartyId)
...
val hcPartyId : kotlin.String = hcPartyId_example // kotlin.String | Healthcare party id
try {
    val result : ContentDto = apiInstance.countOfPatients1(hcPartyId)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PatientApi#countOfPatients1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PatientApi#countOfPatients1")
    e.printStackTrace()
}
```
...
<a name="createPatient1"></a>
# **createPatient1**
> PatientDto createPatient1(patientDto)
...
val patientDto : PatientDto =  // PatientDto | 
try {
    val result : PatientDto = apiInstance.createPatient1(patientDto)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PatientApi#createPatient1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PatientApi#createPatient1")
    e.printStackTrace()
}
```
...
<a name="filterPatientsBy1"></a>
# **filterPatientsBy1**
> PaginatedListPatientDto filterPatientsBy1(filterChainPatient, startKey, startDocumentId, limit, skip, sort, desc)
...
val desc : kotlin.Boolean = true // kotlin.Boolean | Descending
try {
    val result : PaginatedListPatientDto = apiInstance.filterPatientsBy1(filterChainPatient, startKey, startDocumentId, limit, skip, sort, desc)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PatientApi#filterPatientsBy1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PatientApi#filterPatientsBy1")
    e.printStackTrace()
}
```
...
<a name="findByExternalId1"></a>
# **findByExternalId1**
> PatientDto findByExternalId1(externalId)
...
val externalId : kotlin.String = externalId_example // kotlin.String | A external ID
try {
    val result : PatientDto = apiInstance.findByExternalId1(externalId)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PatientApi#findByExternalId1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PatientApi#findByExternalId1")
    e.printStackTrace()
}
```
...
> PaginatedListSerializable findPatientsByNameBirthSsinAuto(healthcarePartyId, filterValue, startKey, startDocumentId, limit, sortDirection)
...
val sortDirection : kotlin.String = sortDirection_example // kotlin.String | Optional value for providing a sorting direction ('asc', 'desc'). Set to 'asc' by default.
try {
    val result : PaginatedListSerializable = apiInstance.findPatientsByNameBirthSsinAuto(healthcarePartyId, filterValue, startKey, startDocumentId, limit, sortDirection)
    println(result)
} catch (e: ClientException) {
...
[**PaginatedListSerializable**](PaginatedListSerializable.md)
...
<a name="fuzzySearch1"></a>
# **fuzzySearch1**
> kotlin.collections.List&lt;PatientDto&gt; fuzzySearch1(firstName, lastName, dateOfBirth)
...
val dateOfBirth : kotlin.Int = 56 // kotlin.Int | The date of birth
try {
    val result : kotlin.collections.List<PatientDto> = apiInstance.fuzzySearch1(firstName, lastName, dateOfBirth)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PatientApi#fuzzySearch1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PatientApi#fuzzySearch1")
    e.printStackTrace()
}
```
...
<a name="getPatient1"></a>
# **getPatient1**
> PatientDto getPatient1(patientId)
...
val patientId : kotlin.String = patientId_example // kotlin.String | 
try {
    val result : PatientDto = apiInstance.getPatient1(patientId)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PatientApi#getPatient1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PatientApi#getPatient1")
    e.printStackTrace()
}
```
...
<a name="getPatientHcPartyKeysForDelegate1"></a>
# **getPatientHcPartyKeysForDelegate1**
> kotlin.String getPatientHcPartyKeysForDelegate1(patientId)
...
val patientId : kotlin.String = patientId_example // kotlin.String | The patient Id for which information is shared
try {
    val result : kotlin.String = apiInstance.getPatientHcPartyKeysForDelegate1(patientId)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PatientApi#getPatientHcPartyKeysForDelegate1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PatientApi#getPatientHcPartyKeysForDelegate1")
    e.printStackTrace()
}
```
...
<a name="getPatients1"></a>
# **getPatients1**
> kotlin.collections.List&lt;PatientDto&gt; getPatients1(listOfIdsDto)
...
val listOfIdsDto : ListOfIdsDto =  // ListOfIdsDto | 
try {
    val result : kotlin.collections.List<PatientDto> = apiInstance.getPatients1(listOfIdsDto)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PatientApi#getPatients1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PatientApi#getPatients1")
    e.printStackTrace()
}
```
...
<a name="listDeletedPatientsByName1"></a>
# **listDeletedPatientsByName1**
> kotlin.collections.List&lt;PatientDto&gt; listDeletedPatientsByName1(firstName, lastName)
...
val lastName : kotlin.String = lastName_example // kotlin.String | Last name prefix
try {
    val result : kotlin.collections.List<PatientDto> = apiInstance.listDeletedPatientsByName1(firstName, lastName)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PatientApi#listDeletedPatientsByName1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PatientApi#listDeletedPatientsByName1")
    e.printStackTrace()
}
```
...
<a name="listOfMergesAfter1"></a>
# **listOfMergesAfter1**
> kotlin.collections.List&lt;PatientDto&gt; listOfMergesAfter1(date)
...
val date : kotlin.Long = 789 // kotlin.Long | 
try {
    val result : kotlin.collections.List<PatientDto> = apiInstance.listOfMergesAfter1(date)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PatientApi#listOfMergesAfter1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PatientApi#listOfMergesAfter1")
    e.printStackTrace()
}
```
...
<a name="matchPatientsBy1"></a>
# **matchPatientsBy1**
> kotlin.collections.List&lt;kotlin.String&gt; matchPatientsBy1(abstractFilterDtoPatient)
...
val abstractFilterDtoPatient : AbstractFilterDtoPatient =  // AbstractFilterDtoPatient | 
try {
    val result : kotlin.collections.List<kotlin.String> = apiInstance.matchPatientsBy1(abstractFilterDtoPatient)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PatientApi#matchPatientsBy1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PatientApi#matchPatientsBy1")
    e.printStackTrace()
}
```
...
<a name="mergeInto1"></a>
# **mergeInto1**
> PatientDto mergeInto1(toId, fromIds)
...
val fromIds : kotlin.String = fromIds_example // kotlin.String | 
try {
    val result : PatientDto = apiInstance.mergeInto1(toId, fromIds)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PatientApi#mergeInto1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PatientApi#mergeInto1")
    e.printStackTrace()
}
```
...
<a name="modifyPatient1"></a>
# **modifyPatient1**
> PatientDto modifyPatient1(patientDto)
...
val patientDto : PatientDto =  // PatientDto | 
try {
    val result : PatientDto = apiInstance.modifyPatient1(patientDto)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PatientApi#modifyPatient1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PatientApi#modifyPatient1")
    e.printStackTrace()
}
```
...
<a name="modifyPatientReferral1"></a>
# **modifyPatientReferral1**
> PatientDto modifyPatientReferral1(patientId, referralId, start, end)
...
val end : kotlin.Long = 789 // kotlin.Long | Optional value for end of referral
try {
    val result : PatientDto = apiInstance.modifyPatientReferral1(patientId, referralId, start, end)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PatientApi#modifyPatientReferral1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PatientApi#modifyPatientReferral1")
    e.printStackTrace()
}
```
...
<a name="newPatientDelegations1"></a>
# **newPatientDelegations1**
> PatientDto newPatientDelegations1(patientId, delegationDto)
...
val delegationDto : kotlin.collections.List<DelegationDto> =  // kotlin.collections.List<DelegationDto> | 
try {
    val result : PatientDto = apiInstance.newPatientDelegations1(patientId, delegationDto)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PatientApi#newPatientDelegations1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PatientApi#newPatientDelegations1")
    e.printStackTrace()
}
```
...
<a name="undeletePatient1"></a>
# **undeletePatient1**
> kotlin.collections.List&lt;DocIdentifier&gt; undeletePatient1(patientIds)
...
val patientIds : kotlin.String = patientIds_example // kotlin.String | 
try {
    val result : kotlin.collections.List<DocIdentifier> = apiInstance.undeletePatient1(patientIds)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PatientApi#undeletePatient1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PatientApi#undeletePatient1")
    e.printStackTrace()
}
```
