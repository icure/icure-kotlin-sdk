...
import org.taktik.icure.services.external.rest.v2.dto.AppointmentTypeAndPlaceDto
import org.taktik.icure.services.external.rest.v2.dto.UserAndHealthcarePartyDto
...
class AnonymousAccessApi(
    ...
    suspend fun getAvailabilitiesByPeriodAndCalendarItemTypeId(
        ...
        val localVariableConfig = getAvailabilitiesByPeriodAndCalendarItemTypeIdRequestConfig(
            groupId = groupId,
            userId = userId,
     ...
     */
    fun getAvailabilitiesByPeriodAndCalendarItemTypeIdRequestConfig(
        groupId: String,
        userId: String,
        calendarItemTypeId: String,
        isNewPatient: Boolean,
        ...
        return RequestConfig(
            ...
            path = "/rest/v2/aa/available/inGroup/{groupId}/forUser/{userId}/type/{calendarItemTypeId}".replace(
                "{" + "groupId" + "}",
                URLEncoder.encode(groupId, Charsets.UTF_8)
            ).replace("{" + "userId" + "}", URLEncoder.encode(userId, Charsets.UTF_8)).replace(
                "{" + "calendarItemTypeId" + "}",
    ...
    suspend fun listAppointmentTypesForUser(
        ...
        startDate: Long,
        endDate: Long
    ): List<AppointmentTypeAndPlaceDto> {
        val localVariableConfig = listAppointmentTypesForUserRequestConfig(
            groupId = groupId,
            userId = userId,
            startDate = startDate,
            endDate = endDate
        ...
        return request<Unit, List<AppointmentTypeAndPlaceDto>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun listAppointmentTypesForUserRequestConfig(
        groupId: String,
        userId: String,
        startDate: Long,
        endDate: Long
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/aa/appointmentType/inGroup/{groupId}/forUser/{userId}".replace(
                "{" + "groupId" + "}",
                URLEncoder.encode(groupId, Charsets.UTF_8)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listHealthcarePartiesInGroup(groupId: String): List<UserAndHealthcarePartyDto> {
        val localVariableConfig = listHealthcarePartiesInGroupRequestConfig(groupId = groupId)

        return request<Unit, List<UserAndHealthcarePartyDto>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun listHealthcarePartiesInGroupRequestConfig(groupId: String): RequestConfig<Unit> {
        // val localVariableBody = null
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/aa/hcparty/inGroup/{groupId}".replace(
                "{" + "groupId" + "}",
                URLEncoder.encode(groupId, Charsets.UTF_8)
            ),
            query = localVariableQuery,
