...
class ApplicationsettingsApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getApplicationSettings1() : kotlin.collections.List<ApplicationSettingsDto>?  {
        val localVariableConfig = getApplicationSettings1RequestConfig()
    ...
    /**
    * To obtain the request config of the operation getApplicationSettings1
    *
    * @return RequestConfig
    */
    fun getApplicationSettings1RequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
