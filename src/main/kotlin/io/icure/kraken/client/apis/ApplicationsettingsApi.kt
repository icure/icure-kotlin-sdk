...
class ApplicationsettingsApi(
    ...
    suspend fun createApplicationSettings(applicationSettingsDto: ApplicationSettingsDto): ApplicationSettingsDto {
        val localVariableConfig =
            createApplicationSettingsRequestConfig(applicationSettingsDto = applicationSettingsDto)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getApplicationSettings(): List<ApplicationSettingsDto> {
        val localVariableConfig = getApplicationSettingsRequestConfig()

        return request<Unit, List<ApplicationSettingsDto>>(
            localVariableConfig
        )!!
    }
    ...
    suspend fun updateApplicationSettings(applicationSettingsDto: ApplicationSettingsDto): ApplicationSettingsDto {
        val localVariableConfig =
            updateApplicationSettingsRequestConfig(applicationSettingsDto = applicationSettingsDto)
