...
class ArticleApi(
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun deleteArticles(listOfIdsDto: ListOfIdsDto): List<DocIdentifier> {
     ...
     * @return RequestConfig
     */
    fun getArticleRequestConfig(articleId: String): RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/rest/v2/article/{articleId}".replace(
                "{" + "articleId" + "}",
                URLEncoder.encode(articleId, Charsets.UTF_8)
            ),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
    ...
    suspend fun getArticles(): List<ArticleDto> {
        ...
        return request<Unit, List<ArticleDto>>(
            localVariableConfig
        )!!
    }
