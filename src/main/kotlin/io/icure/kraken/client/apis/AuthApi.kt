...
class AuthApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun login1(session: WebSession) : AuthenticationResponse?  {
        val localVariableConfig = login1RequestConfig(session = session)
    ...
    /**
    * To obtain the request config of the operation login1
    *
    * @param session  
    * @return RequestConfig
    */
    fun login1RequestConfig(session: WebSession) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                put("session", listOf(session.toString()))
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun logout1() : AuthenticationResponse?  {
        val localVariableConfig = logout1RequestConfig()
    ...
    /**
    * To obtain the request config of the operation logout1
    *
    * @return RequestConfig
    */
    fun logout1RequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun logoutPost1() : AuthenticationResponse?  {
        val localVariableConfig = logoutPost1RequestConfig()
    ...
    /**
    * To obtain the request config of the operation logoutPost1
    *
    * @return RequestConfig
    */
    fun logoutPost1RequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun token1(method: kotlin.String, path: kotlin.String) : kotlin.String?  {
        val localVariableConfig = token1RequestConfig(method = method, path = path)
    ...
    /**
    * To obtain the request config of the operation token1
    *
    * @param method  
    * @param path  
    * @return RequestConfig
    */
    fun token1RequestConfig(method: kotlin.String, path: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
