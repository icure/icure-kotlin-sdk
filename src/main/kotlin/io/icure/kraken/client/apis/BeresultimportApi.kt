...
class BeresultimportApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun canHandle1(id: kotlin.String, enckeys: kotlin.String) : kotlin.Boolean?  {
        val localVariableConfig = canHandle1RequestConfig(id = id, enckeys = enckeys)
    ...
    /**
    * To obtain the request config of the operation canHandle1
    *
    * @param id  
    * @param enckeys  
    * @return RequestConfig
    */
    fun canHandle1RequestConfig(id: kotlin.String, enckeys: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                put("enckeys", listOf(enckeys.toString()))
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun doImport1(documentId: kotlin.String, hcpId: kotlin.String, language: kotlin.String, protocolIds: kotlin.String, formIds: kotlin.String, planOfActionId: kotlin.String, enckeys: kotlin.String, ctc: ContactDto) : ContactDto?  {
        val localVariableConfig = doImport1RequestConfig(documentId = documentId, hcpId = hcpId, language = language, protocolIds = protocolIds, formIds = formIds, planOfActionId = planOfActionId, enckeys = enckeys, ctc = ctc)
    ...
    /**
    * To obtain the request config of the operation doImport1
    *
    * @param documentId  
    * @param hcpId  
    * @param language  
    ...
    * @return RequestConfig
    */
    fun doImport1RequestConfig(documentId: kotlin.String, hcpId: kotlin.String, language: kotlin.String, protocolIds: kotlin.String, formIds: kotlin.String, planOfActionId: kotlin.String, enckeys: kotlin.String, ctc: ContactDto) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                put("protocolIds", listOf(protocolIds.toString()))
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getInfos1(id: kotlin.String, language: kotlin.String, enckeys: kotlin.String, full: kotlin.Boolean?) : kotlin.collections.List<ResultInfoDto>?  {
        val localVariableConfig = getInfos1RequestConfig(id = id, language = language, enckeys = enckeys, full = full)
    ...
    /**
    * To obtain the request config of the operation getInfos1
    *
    * @param id  
    * @param language  
    * @param enckeys  
    ...
    * @return RequestConfig
    */
    fun getInfos1RequestConfig(id: kotlin.String, language: kotlin.String, enckeys: kotlin.String, full: kotlin.Boolean?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                put("language", listOf(language.toString()))
