...
class CalendarItemApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createCalendarItem1(calendarItemDto: CalendarItemDto) : CalendarItemDto?  {
        val localVariableConfig = createCalendarItem1RequestConfig(calendarItemDto = calendarItemDto)
    ...
    /**
    * To obtain the request config of the operation createCalendarItem1
    *
    * @param calendarItemDto  
    * @return RequestConfig
    */
    fun createCalendarItem1RequestConfig(calendarItemDto: CalendarItemDto) : RequestConfig<CalendarItemDto> {
        val localVariableBody = calendarItemDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun findCalendarItemsByHCPartyPatientForeignKeys1(hcPartyId: kotlin.String, secretFKeys: kotlin.String) : kotlin.collections.List<CalendarItemDto>?  {
        val localVariableConfig = findCalendarItemsByHCPartyPatientForeignKeys1RequestConfig(hcPartyId = hcPartyId, secretFKeys = secretFKeys)
    ...
    /**
    * To obtain the request config of the operation findCalendarItemsByHCPartyPatientForeignKeys1
    *
    * @param hcPartyId  
    * @param secretFKeys  
    * @return RequestConfig
    */
    fun findCalendarItemsByHCPartyPatientForeignKeys1RequestConfig(hcPartyId: kotlin.String, secretFKeys: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                put("hcPartyId", listOf(hcPartyId.toString()))
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getCalendarItem1(calendarItemId: kotlin.String) : CalendarItemDto?  {
        val localVariableConfig = getCalendarItem1RequestConfig(calendarItemId = calendarItemId)
    ...
    /**
    * To obtain the request config of the operation getCalendarItem1
    *
    * @param calendarItemId  
    * @return RequestConfig
    */
    fun getCalendarItem1RequestConfig(calendarItemId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getCalendarItems1() : kotlin.collections.List<CalendarItemDto>?  {
        val localVariableConfig = getCalendarItems1RequestConfig()
    ...
    /**
    * To obtain the request config of the operation getCalendarItems1
    *
    * @return RequestConfig
    */
    fun getCalendarItems1RequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getCalendarItemsByPeriodAndHcPartyId1(startDate: kotlin.Long, endDate: kotlin.Long, hcPartyId: kotlin.String) : kotlin.collections.List<CalendarItemDto>?  {
        val localVariableConfig = getCalendarItemsByPeriodAndHcPartyId1RequestConfig(startDate = startDate, endDate = endDate, hcPartyId = hcPartyId)
    ...
    /**
    * To obtain the request config of the operation getCalendarItemsByPeriodAndHcPartyId1
    *
    * @param startDate  
    * @param endDate  
    * @param hcPartyId  
    * @return RequestConfig
    */
    fun getCalendarItemsByPeriodAndHcPartyId1RequestConfig(startDate: kotlin.Long, endDate: kotlin.Long, hcPartyId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                put("startDate", listOf(startDate.toString()))
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getCalendarItemsWithIds1(listOfIdsDto: ListOfIdsDto?) : kotlin.collections.List<CalendarItemDto>?  {
        val localVariableConfig = getCalendarItemsWithIds1RequestConfig(listOfIdsDto = listOfIdsDto)
    ...
    /**
    * To obtain the request config of the operation getCalendarItemsWithIds1
    *
    * @param listOfIdsDto  (optional)
    * @return RequestConfig
    */
    fun getCalendarItemsWithIds1RequestConfig(listOfIdsDto: ListOfIdsDto?) : RequestConfig<ListOfIdsDto> {
        val localVariableBody = listOfIdsDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getCalendarsByPeriodAndAgendaId1(startDate: kotlin.Long, endDate: kotlin.Long, agendaId: kotlin.String) : kotlin.collections.List<CalendarItemDto>?  {
        val localVariableConfig = getCalendarsByPeriodAndAgendaId1RequestConfig(startDate = startDate, endDate = endDate, agendaId = agendaId)
    ...
    /**
    * To obtain the request config of the operation getCalendarsByPeriodAndAgendaId1
    *
    * @param startDate  
    * @param endDate  
    * @param agendaId  
    * @return RequestConfig
    */
    fun getCalendarsByPeriodAndAgendaId1RequestConfig(startDate: kotlin.Long, endDate: kotlin.Long, agendaId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                put("startDate", listOf(startDate.toString()))
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyCalendarItem1(calendarItemDto: CalendarItemDto) : CalendarItemDto?  {
        val localVariableConfig = modifyCalendarItem1RequestConfig(calendarItemDto = calendarItemDto)
    ...
    /**
    * To obtain the request config of the operation modifyCalendarItem1
    *
    * @param calendarItemDto  
    * @return RequestConfig
    */
    fun modifyCalendarItem1RequestConfig(calendarItemDto: CalendarItemDto) : RequestConfig<CalendarItemDto> {
        val localVariableBody = calendarItemDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun setCalendarItemsDelegations1(icureStubDto: kotlin.collections.List<IcureStubDto>?) : kotlin.collections.List<CalendarItemDto>?  {
        val localVariableConfig = setCalendarItemsDelegations1RequestConfig(icureStubDto = icureStubDto)
    ...
    /**
    * To obtain the request config of the operation setCalendarItemsDelegations1
    *
    * @param icureStubDto  (optional)
    * @return RequestConfig
    */
    fun setCalendarItemsDelegations1RequestConfig(icureStubDto: kotlin.collections.List<IcureStubDto>?) : RequestConfig<kotlin.collections.List<IcureStubDto>> {
        val localVariableBody = icureStubDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
