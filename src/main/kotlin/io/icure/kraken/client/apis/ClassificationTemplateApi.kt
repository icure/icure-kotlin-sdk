...
class ClassificationTemplateApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createClassificationTemplate1(classificationTemplateDto: ClassificationTemplateDto) : ClassificationTemplateDto?  {
        val localVariableConfig = createClassificationTemplate1RequestConfig(classificationTemplateDto = classificationTemplateDto)
    ...
    /**
    * To obtain the request config of the operation createClassificationTemplate1
    *
    * @param classificationTemplateDto  
    * @return RequestConfig
    */
    fun createClassificationTemplate1RequestConfig(classificationTemplateDto: ClassificationTemplateDto) : RequestConfig<ClassificationTemplateDto> {
        val localVariableBody = classificationTemplateDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun deleteClassificationTemplates1(classificationTemplateIds: kotlin.String) : kotlin.collections.List<DocIdentifier>?  {
        val localVariableConfig = deleteClassificationTemplates1RequestConfig(classificationTemplateIds = classificationTemplateIds)
    ...
    /**
    * To obtain the request config of the operation deleteClassificationTemplates1
    *
    * @param classificationTemplateIds  
    * @return RequestConfig
    */
    fun deleteClassificationTemplates1RequestConfig(classificationTemplateIds: kotlin.String) : RequestConfig<Unit> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getClassificationTemplate1(classificationTemplateId: kotlin.String) : ClassificationTemplateDto?  {
        val localVariableConfig = getClassificationTemplate1RequestConfig(classificationTemplateId = classificationTemplateId)
    ...
    /**
    * To obtain the request config of the operation getClassificationTemplate1
    *
    * @param classificationTemplateId  
    * @return RequestConfig
    */
    fun getClassificationTemplate1RequestConfig(classificationTemplateId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getClassificationTemplateByIds1(ids: kotlin.String) : kotlin.collections.List<ClassificationTemplateDto>?  {
        val localVariableConfig = getClassificationTemplateByIds1RequestConfig(ids = ids)
    ...
    /**
    * To obtain the request config of the operation getClassificationTemplateByIds1
    *
    * @param ids  
    * @return RequestConfig
    */
    fun getClassificationTemplateByIds1RequestConfig(ids: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyClassificationTemplate1(classificationTemplateDto: ClassificationTemplateDto) : ClassificationTemplateDto?  {
        val localVariableConfig = modifyClassificationTemplate1RequestConfig(classificationTemplateDto = classificationTemplateDto)
    ...
    /**
    * To obtain the request config of the operation modifyClassificationTemplate1
    *
    * @param classificationTemplateDto  
    * @return RequestConfig
    */
    fun modifyClassificationTemplate1RequestConfig(classificationTemplateDto: ClassificationTemplateDto) : RequestConfig<ClassificationTemplateDto> {
        val localVariableBody = classificationTemplateDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun newClassificationTemplateDelegations1(classificationTemplateId: kotlin.String, delegationDto: kotlin.collections.List<DelegationDto>) : ClassificationTemplateDto?  {
        val localVariableConfig = newClassificationTemplateDelegations1RequestConfig(classificationTemplateId = classificationTemplateId, delegationDto = delegationDto)
    ...
    /**
    * To obtain the request config of the operation newClassificationTemplateDelegations1
    *
    * @param classificationTemplateId  
    * @param delegationDto  
    * @return RequestConfig
    */
    fun newClassificationTemplateDelegations1RequestConfig(classificationTemplateId: kotlin.String, delegationDto: kotlin.collections.List<DelegationDto>) : RequestConfig<kotlin.collections.List<DelegationDto>> {
        val localVariableBody = delegationDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
