...
class ClassificationTemplateApi(
    ...
    suspend fun createClassificationTemplate(classificationTemplateDto: ClassificationTemplateDto): ClassificationTemplateDto {
        val localVariableConfig =
            createClassificationTemplateRequestConfig(classificationTemplateDto = classificationTemplateDto)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun deleteClassificationTemplates(listOfIdsDto: ListOfIdsDto): List<DocIdentifier> {
    ...
    suspend fun findClassificationTemplatesBy(
        ...
        val localVariableConfig = findClassificationTemplatesByRequestConfig(
            startKey = startKey,
     ...
     * @return RequestConfig
     */
    fun findClassificationTemplatesByRequestConfig(
        startKey: String?,
        startDocumentId: String?,
        limit: Int?
    ): RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getClassificationTemplate(classificationTemplateId: String): ClassificationTemplateDto {
        val localVariableConfig =
            getClassificationTemplateRequestConfig(classificationTemplateId = classificationTemplateId)
     ...
     * @return RequestConfig
     */
    fun getClassificationTemplateRequestConfig(classificationTemplateId: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/classificationTemplate/{classificationTemplateId}".replace(
                "{" + "classificationTemplateId" + "}",
                URLEncoder.encode(classificationTemplateId, Charsets.UTF_8)
            ),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getClassificationTemplateByIds(ids: String): List<ClassificationTemplateDto> {
        val localVariableConfig = getClassificationTemplateByIdsRequestConfig(ids = ids)

        return request<Unit, List<ClassificationTemplateDto>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun getClassificationTemplateByIdsRequestConfig(ids: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/classificationTemplate/byIds/{ids}".replace(
                "{" + "ids" + "}",
    ...
    suspend fun listClassificationTemplatesByHCPartyPatientForeignKeys(
        hcPartyId: String,
        secretFKeys: String
    ): List<ClassificationTemplateDto> {
        val localVariableConfig = listClassificationTemplatesByHCPartyPatientForeignKeysRequestConfig(
            hcPartyId = hcPartyId,
     ...
     * @return RequestConfig
     */
    fun listClassificationTemplatesByHCPartyPatientForeignKeysRequestConfig(
        hcPartyId: String,
        secretFKeys: String
    ): RequestConfig<Unit> {
        // val localVariableBody = null
    ...
    suspend fun modifyClassificationTemplate(classificationTemplateDto: ClassificationTemplateDto): ClassificationTemplateDto {
        val localVariableConfig =
            modifyClassificationTemplateRequestConfig(classificationTemplateDto = classificationTemplateDto)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun newClassificationTemplateDelegations(
        classificationTemplateId: String,
        delegationDto: List<DelegationDto>
    ): ClassificationTemplateDto {
        val localVariableConfig = newClassificationTemplateDelegationsRequestConfig(
            classificationTemplateId = classificationTemplateId,
            delegationDto = delegationDto
        )

        return request<List<DelegationDto>, ClassificationTemplateDto>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun newClassificationTemplateDelegationsRequestConfig(
        classificationTemplateId: String,
        delegationDto: List<DelegationDto>
        ...
        return RequestConfig(
            method = RequestMethod.POST,
            path = "/rest/v2/classificationTemplate/{classificationTemplateId}/delegate".replace(
                "{" + "classificationTemplateId" + "}",
                URLEncoder.encode(classificationTemplateId, Charsets.UTF_8)
            ),
            query = localVariableQuery,
