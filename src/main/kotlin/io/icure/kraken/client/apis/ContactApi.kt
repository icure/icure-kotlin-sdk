...
class ContactApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun closeForHCPartyPatientForeignKeys1(hcPartyId: kotlin.String, secretFKeys: kotlin.String) : kotlin.collections.List<ContactDto>?  {
        val localVariableConfig = closeForHCPartyPatientForeignKeys1RequestConfig(hcPartyId = hcPartyId, secretFKeys = secretFKeys)
    ...
    /**
    * To obtain the request config of the operation closeForHCPartyPatientForeignKeys1
    *
    * @param hcPartyId  
    * @param secretFKeys  
    * @return RequestConfig
    */
    fun closeForHCPartyPatientForeignKeys1RequestConfig(hcPartyId: kotlin.String, secretFKeys: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                put("hcPartyId", listOf(hcPartyId.toString()))
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createContact1(contactDto: ContactDto) : ContactDto?  {
        val localVariableConfig = createContact1RequestConfig(contactDto = contactDto)
    ...
    /**
    * To obtain the request config of the operation createContact1
    *
    * @param contactDto  
    * @return RequestConfig
    */
    fun createContact1RequestConfig(contactDto: ContactDto) : RequestConfig<ContactDto> {
        val localVariableBody = contactDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createContacts1(contactDto: kotlin.collections.List<ContactDto>) : kotlin.collections.List<ContactDto>?  {
        val localVariableConfig = createContacts1RequestConfig(contactDto = contactDto)
    ...
    /**
    * To obtain the request config of the operation createContacts1
    *
    * @param contactDto  
    * @return RequestConfig
    */
    fun createContacts1RequestConfig(contactDto: kotlin.collections.List<ContactDto>) : RequestConfig<kotlin.collections.List<ContactDto>> {
        val localVariableBody = contactDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun deleteContacts1(contactIds: kotlin.String) : kotlin.collections.List<DocIdentifier>?  {
        val localVariableConfig = deleteContacts1RequestConfig(contactIds = contactIds)
    ...
    /**
    * To obtain the request config of the operation deleteContacts1
    *
    * @param contactIds  
    * @return RequestConfig
    */
    fun deleteContacts1RequestConfig(contactIds: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun filterContactsBy1(filterChainContact: FilterChainContact, startDocumentId: kotlin.String?, limit: kotlin.Int?) : PaginatedListContactDto?  {
        val localVariableConfig = filterContactsBy1RequestConfig(filterChainContact = filterChainContact, startDocumentId = startDocumentId, limit = limit)
    ...
    /**
    * To obtain the request config of the operation filterContactsBy1
    *
    * @param filterChainContact  
    * @param startDocumentId A Contact document ID (optional)
    * @param limit Number of rows (optional)
    * @return RequestConfig
    */
    fun filterContactsBy1RequestConfig(filterChainContact: FilterChainContact, startDocumentId: kotlin.String?, limit: kotlin.Int?) : RequestConfig<FilterChainContact> {
        val localVariableBody = filterChainContact
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (startDocumentId != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun filterServicesBy1(filterChainService: FilterChainService, startDocumentId: kotlin.String?, limit: kotlin.Int?) : PaginatedListServiceDto?  {
        val localVariableConfig = filterServicesBy1RequestConfig(filterChainService = filterChainService, startDocumentId = startDocumentId, limit = limit)
    ...
    /**
    * To obtain the request config of the operation filterServicesBy1
    *
    * @param filterChainService  
    * @param startDocumentId A Contact document ID (optional)
    * @param limit Number of rows (optional)
    * @return RequestConfig
    */
    fun filterServicesBy1RequestConfig(filterChainService: FilterChainService, startDocumentId: kotlin.String?, limit: kotlin.Int?) : RequestConfig<FilterChainService> {
        val localVariableBody = filterChainService
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (startDocumentId != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getContact1(contactId: kotlin.String) : ContactDto?  {
        val localVariableConfig = getContact1RequestConfig(contactId = contactId)
    ...
    /**
    * To obtain the request config of the operation getContact1
    *
    * @param contactId  
    * @return RequestConfig
    */
    fun getContact1RequestConfig(contactId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getContacts1(listOfIdsDto: ListOfIdsDto) : kotlin.collections.List<ContactDto>?  {
        val localVariableConfig = getContacts1RequestConfig(listOfIdsDto = listOfIdsDto)
    ...
    /**
    * To obtain the request config of the operation getContacts1
    *
    * @param listOfIdsDto  
    * @return RequestConfig
    */
    fun getContacts1RequestConfig(listOfIdsDto: ListOfIdsDto) : RequestConfig<ListOfIdsDto> {
        val localVariableBody = listOfIdsDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getEmptyContent1() : ContentDto?  {
        val localVariableConfig = getEmptyContent1RequestConfig()
    ...
    /**
    * To obtain the request config of the operation getEmptyContent1
    *
    * @return RequestConfig
    */
    fun getEmptyContent1RequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getServiceCodesOccurences1(codeType: kotlin.String, minOccurences: kotlin.Long) : kotlin.collections.List<LabelledOccurenceDto>?  {
        val localVariableConfig = getServiceCodesOccurences1RequestConfig(codeType = codeType, minOccurences = minOccurences)
    ...
    /**
    * To obtain the request config of the operation getServiceCodesOccurences1
    *
    * @param codeType  
    * @param minOccurences  
    * @return RequestConfig
    */
    fun getServiceCodesOccurences1RequestConfig(codeType: kotlin.String, minOccurences: kotlin.Long) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun matchContactsBy1(abstractFilterDtoContact: io.icure.kraken.client.models.filter.AbstractFilterDto<io.icure.kraken.client.models.ContactDto>) : kotlin.collections.List<kotlin.String>?  {
        val localVariableConfig = matchContactsBy1RequestConfig(abstractFilterDtoContact = abstractFilterDtoContact)
    ...
    /**
    * To obtain the request config of the operation matchContactsBy1
    *
    * @param abstractFilterDtoContact  
    * @return RequestConfig
    */
    fun matchContactsBy1RequestConfig(abstractFilterDtoContact: io.icure.kraken.client.models.filter.AbstractFilterDto<io.icure.kraken.client.models.ContactDto>) : RequestConfig<io.icure.kraken.client.models.filter.AbstractFilterDto<io.icure.kraken.client.models.ContactDto>> {
        val localVariableBody = abstractFilterDtoContact
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyContact1(contactDto: ContactDto) : ContactDto?  {
        val localVariableConfig = modifyContact1RequestConfig(contactDto = contactDto)
    ...
    /**
    * To obtain the request config of the operation modifyContact1
    *
    * @param contactDto  
    * @return RequestConfig
    */
    fun modifyContact1RequestConfig(contactDto: ContactDto) : RequestConfig<ContactDto> {
        val localVariableBody = contactDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyContacts1(contactDto: kotlin.collections.List<ContactDto>) : kotlin.collections.List<ContactDto>?  {
        val localVariableConfig = modifyContacts1RequestConfig(contactDto = contactDto)
    ...
    /**
    * To obtain the request config of the operation modifyContacts1
    *
    * @param contactDto  
    * @return RequestConfig
    */
    fun modifyContacts1RequestConfig(contactDto: kotlin.collections.List<ContactDto>) : RequestConfig<kotlin.collections.List<ContactDto>> {
        val localVariableBody = contactDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun newContactDelegations1(contactId: kotlin.String, delegationDto: DelegationDto) : ContactDto?  {
        val localVariableConfig = newContactDelegations1RequestConfig(contactId = contactId, delegationDto = delegationDto)
    ...
    /**
    * To obtain the request config of the operation newContactDelegations1
    *
    * @param contactId  
    * @param delegationDto  
    * @return RequestConfig
    */
    fun newContactDelegations1RequestConfig(contactId: kotlin.String, delegationDto: DelegationDto) : RequestConfig<DelegationDto> {
        val localVariableBody = delegationDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
