...
class DocumentApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    * @return RequestConfig
    */
    fun setDocumentAttachmentMultiRequestConfig(documentId: kotlin.String, attachment: io.icure.kraken.client.infrastructure.ByteArrayWrapper, enckeys: kotlin.String?) : RequestConfig<Map<String, Any?>> {
