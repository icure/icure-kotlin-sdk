...
class DocumentApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    * @return RequestConfig
    */
    fun setDocumentAttachmentMultiRequestConfig(documentId: kotlin.String, attachment: io.icure.kraken.client.infrastructure.ByteArrayWrapper, enckeys: kotlin.String?) : RequestConfig<kotlinx.coroutines.flow.Flow<java.nio.ByteBuffer>> {
        ...
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "multipart/form-data; boundary=${boundary}")
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            ...
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody.let { listOf(
                ByteBuffer.wrap("""--${boundary}
Content-Disposition: form-data; name="attachment"
Content-Type: application/octet-stream

""".toByteArray(Charsets.UTF_8)),
                ByteBuffer.wrap(localVariableBody.byteArray),
