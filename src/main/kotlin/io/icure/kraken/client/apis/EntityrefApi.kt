...
class EntityrefApi(
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getLatest(prefix: String): EntityReferenceDto {
     ...
     * @return RequestConfig
     */
    fun getLatestRequestConfig(prefix: String): RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/rest/v2/entityref/latest/{prefix}".replace(
                "{" + "prefix" + "}",
                URLEncoder.encode(prefix, Charsets.UTF_8)
            ),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
