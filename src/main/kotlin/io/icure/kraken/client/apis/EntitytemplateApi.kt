...
class EntitytemplateApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createEntityTemplate1(entityTemplateDto: EntityTemplateDto) : EntityTemplateDto?  {
        val localVariableConfig = createEntityTemplate1RequestConfig(entityTemplateDto = entityTemplateDto)
    ...
    /**
    * To obtain the request config of the operation createEntityTemplate1
    *
    * @param entityTemplateDto  
    * @return RequestConfig
    */
    fun createEntityTemplate1RequestConfig(entityTemplateDto: EntityTemplateDto) : RequestConfig<EntityTemplateDto> {
        val localVariableBody = entityTemplateDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createEntityTemplates1(entityTemplateDto: kotlin.collections.List<EntityTemplateDto>) : kotlin.collections.List<EntityTemplateDto>?  {
        val localVariableConfig = createEntityTemplates1RequestConfig(entityTemplateDto = entityTemplateDto)
    ...
    /**
    * To obtain the request config of the operation createEntityTemplates1
    *
    * @param entityTemplateDto  
    * @return RequestConfig
    */
    fun createEntityTemplates1RequestConfig(entityTemplateDto: kotlin.collections.List<EntityTemplateDto>) : RequestConfig<kotlin.collections.List<EntityTemplateDto>> {
        val localVariableBody = entityTemplateDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun deleteEntityTemplate1(entityTemplateIds: kotlin.String) : kotlin.collections.List<DocIdentifier>?  {
        val localVariableConfig = deleteEntityTemplate1RequestConfig(entityTemplateIds = entityTemplateIds)
    ...
    /**
    * To obtain the request config of the operation deleteEntityTemplate1
    *
    * @param entityTemplateIds  
    * @return RequestConfig
    */
    fun deleteEntityTemplate1RequestConfig(entityTemplateIds: kotlin.String) : RequestConfig<Unit> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun findAllEntityTemplatesByKeyword1(type: kotlin.String, keyword: kotlin.String, includeEntities: kotlin.Boolean?) : kotlin.collections.List<EntityTemplateDto>?  {
        val localVariableConfig = findAllEntityTemplatesByKeyword1RequestConfig(type = type, keyword = keyword, includeEntities = includeEntities)
    ...
    /**
    * To obtain the request config of the operation findAllEntityTemplatesByKeyword1
    *
    * @param type  
    * @param keyword  
    * @param includeEntities  (optional)
    * @return RequestConfig
    */
    fun findAllEntityTemplatesByKeyword1RequestConfig(type: kotlin.String, keyword: kotlin.String, includeEntities: kotlin.Boolean?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (includeEntities != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getEntityTemplate1(entityTemplateId: kotlin.String) : EntityTemplateDto?  {
        val localVariableConfig = getEntityTemplate1RequestConfig(entityTemplateId = entityTemplateId)
    ...
    /**
    * To obtain the request config of the operation getEntityTemplate1
    *
    * @param entityTemplateId EntityTemplate id 
    * @return RequestConfig
    */
    fun getEntityTemplate1RequestConfig(entityTemplateId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getEntityTemplates1(entityTemplateIds: kotlin.String) : kotlin.collections.List<EntityTemplateDto>?  {
        val localVariableConfig = getEntityTemplates1RequestConfig(entityTemplateIds = entityTemplateIds)
    ...
    /**
    * To obtain the request config of the operation getEntityTemplates1
    *
    * @param entityTemplateIds  
    * @return RequestConfig
    */
    fun getEntityTemplates1RequestConfig(entityTemplateIds: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyEntityTemplate1(entityTemplateDto: EntityTemplateDto) : EntityTemplateDto?  {
        val localVariableConfig = modifyEntityTemplate1RequestConfig(entityTemplateDto = entityTemplateDto)
    ...
    /**
    * To obtain the request config of the operation modifyEntityTemplate1
    *
    * @param entityTemplateDto  
    * @return RequestConfig
    */
    fun modifyEntityTemplate1RequestConfig(entityTemplateDto: EntityTemplateDto) : RequestConfig<EntityTemplateDto> {
        val localVariableBody = entityTemplateDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyEntityTemplates1(entityTemplateDto: kotlin.collections.List<EntityTemplateDto>) : kotlin.collections.List<EntityTemplateDto>?  {
        val localVariableConfig = modifyEntityTemplates1RequestConfig(entityTemplateDto = entityTemplateDto)
    ...
    /**
    * To obtain the request config of the operation modifyEntityTemplates1
    *
    * @param entityTemplateDto  
    * @return RequestConfig
    */
    fun modifyEntityTemplates1RequestConfig(entityTemplateDto: kotlin.collections.List<EntityTemplateDto>) : RequestConfig<kotlin.collections.List<EntityTemplateDto>> {
        val localVariableBody = entityTemplateDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
