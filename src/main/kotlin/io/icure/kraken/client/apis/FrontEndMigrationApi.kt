...
class FrontEndMigrationApi(
     ...
     * @return RequestConfig
     */
    fun deleteFrontEndMigrationRequestConfig(frontEndMigrationId: String): RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/rest/v2/frontendmigration/{frontEndMigrationId}".replace(
                "{" + "frontEndMigrationId" + "}",
                URLEncoder.encode(frontEndMigrationId, Charsets.UTF_8)
            ),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getFrontEndMigration(frontEndMigrationId: String): FrontEndMigrationDto {
     ...
     * @return RequestConfig
     */
    fun getFrontEndMigrationRequestConfig(frontEndMigrationId: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getFrontEndMigrationByName(frontEndMigrationName: String): List<FrontEndMigrationDto> {
        val localVariableConfig = getFrontEndMigrationByNameRequestConfig(frontEndMigrationName = frontEndMigrationName)

        return request<Unit, List<FrontEndMigrationDto>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun getFrontEndMigrationByNameRequestConfig(frontEndMigrationName: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/frontendmigration/byName/{frontEndMigrationName}".replace(
                "{" + "frontEndMigrationName" + "}",
                URLEncoder.encode(frontEndMigrationName, Charsets.UTF_8)
            ),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getFrontEndMigrations(): List<FrontEndMigrationDto> {
