...
class GroupApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getReplicationInfo2(id: kotlin.String) : ReplicationInfoDto?  {
        val localVariableConfig = getReplicationInfo2RequestConfig(id = id)
    ...
    /**
    * To obtain the request config of the operation getReplicationInfo2
    *
    * @param id The id of the group 
    * @return RequestConfig
    */
    fun getReplicationInfo2RequestConfig(id: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
