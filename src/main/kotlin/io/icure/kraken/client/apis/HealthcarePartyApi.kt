...
class HealthcarePartyApi(
    ...
    suspend fun createHealthcarePartyInGroup(
        ...
        val localVariableConfig =
            createHealthcarePartyInGroupRequestConfig(groupId = groupId, healthcarePartyDto = healthcarePartyDto)
     ...
     * @return RequestConfig
     */
    fun createHealthcarePartyInGroupRequestConfig(
        groupId: String,
        healthcarePartyDto: HealthcarePartyDto
    ): RequestConfig<HealthcarePartyDto> {
        // val localVariableBody = healthcarePartyDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            method = RequestMethod.POST,
            path = "/rest/v2/hcparty/inGroup/{groupId}".replace(
                "{" + "groupId" + "}",
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun deleteHealthcareParties(listOfIdsDto: ListOfIdsDto): List<DocIdentifier> {
    ...
    suspend fun deleteHealthcarePartiesInGroup(
        ...
        val localVariableConfig =
            deleteHealthcarePartiesInGroupRequestConfig(groupId = groupId, listOfIdsDto = listOfIdsDto)
     ...
     * @return RequestConfig
     */
    fun deleteHealthcarePartiesInGroupRequestConfig(
        groupId: String,
        listOfIdsDto: ListOfIdsDto
        ...
        return RequestConfig(
            method = RequestMethod.POST,
            path = "/rest/v2/hcparty/delete/batch/inGroup/{groupId}".replace(
                "{" + "groupId" + "}",
                URLEncoder.encode(groupId, Charsets.UTF_8)
            ),
            query = localVariableQuery,
    ...
    suspend fun filterHealthPartiesBy(
        filterChainHealthcareParty: io.icure.kraken.client.models.filter.chain.FilterChain<HealthcarePartyDto>,
        startDocumentId: String?,
        limit: Int?
    ): PaginatedListHealthcarePartyDto {
        val localVariableConfig = filterHealthPartiesByRequestConfig(
            filterChainHealthcareParty = filterChainHealthcareParty,
            startDocumentId = startDocumentId,
            limit = limit
        )

        return request<io.icure.kraken.client.models.filter.chain.FilterChain<HealthcarePartyDto>, PaginatedListHealthcarePartyDto>(
            localVariableConfig
        )!!
    }
    ...
    fun filterHealthPartiesByRequestConfig(
        ...
        startDocumentId: String?,
        limit: Int?
    ): RequestConfig<io.icure.kraken.client.models.filter.chain.FilterChain<HealthcarePartyDto>> {
    ...
    suspend fun findHealthcarePartiesBy(
        ...
        val localVariableConfig = findHealthcarePartiesByRequestConfig(
            startKey = startKey,
            startDocumentId = startDocumentId,
            limit = limit,
            desc = desc
     ...
     * @return RequestConfig
     */
    fun findHealthcarePartiesByRequestConfig(
        startKey: String?,
        startDocumentId: String?,
        limit: Int?,
        desc: Boolean?
    ...
    suspend fun findHealthcarePartiesByName(
        ...
        val localVariableConfig = findHealthcarePartiesByNameRequestConfig(
            name = name,
            startKey = startKey,
            startDocumentId = startDocumentId,
            limit = limit,
     ...
     * @return RequestConfig
     */
    fun findHealthcarePartiesByNameRequestConfig(
        name: String?,
        startKey: String?,
        startDocumentId: String?,
        limit: Int?,
    ...
    suspend fun findHealthcarePartiesBySpecialityAndPostCode(
        ...
        val localVariableConfig = findHealthcarePartiesBySpecialityAndPostCodeRequestConfig(
            type = type,
            spec = spec,
            firstCode = firstCode,
            lastCode = lastCode,
     ...
     * @return RequestConfig
     */
    fun findHealthcarePartiesBySpecialityAndPostCodeRequestConfig(
        type: String,
        spec: String,
        firstCode: String,
        lastCode: String,
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/hcparty/bySpecialityAndPostCode/{type}/{spec}/{firstCode}/to/{lastCode}".replace(
                "{" + "type" + "}",
                URLEncoder.encode(type, Charsets.UTF_8)
            ).replace("{" + "spec" + "}", URLEncoder.encode(spec, Charsets.UTF_8))
                .replace("{" + "firstCode" + "}", URLEncoder.encode(firstCode, Charsets.UTF_8))
                .replace("{" + "lastCode" + "}", URLEncoder.encode(lastCode, Charsets.UTF_8)),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    suspend fun findHealthcarePartiesBySsinOrNihii(
        ...
        val localVariableConfig = findHealthcarePartiesBySsinOrNihiiRequestConfig(
     ...
     * @return RequestConfig
     */
    fun findHealthcarePartiesBySsinOrNihiiRequestConfig(
        searchValue: String,
        startKey: String?,
        startDocumentId: String?,
        limit: Int?,
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/hcparty/byNihiiOrSsin/{searchValue}".replace(
                "{" + "searchValue" + "}",
                URLEncoder.encode(searchValue, Charsets.UTF_8)
            ),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
     ...
     * @return RequestConfig
     */
    fun getAesExchangeKeysForDelegateRequestConfig(healthcarePartyId: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/hcparty/{healthcarePartyId}/aesExchangeKeys".replace(
                "{" + "healthcarePartyId" + "}",
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getHealthcareParties(listOfIdsDto: ListOfIdsDto): List<HealthcarePartyDto> {
        val localVariableConfig = getHealthcarePartiesRequestConfig(listOfIdsDto = listOfIdsDto)

        return request<ListOfIdsDto, List<HealthcarePartyDto>>(
            localVariableConfig
        )!!
    }
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getHealthcareParty(healthcarePartyId: String): HealthcarePartyDto {
     ...
     * @return RequestConfig
     */
    fun getHealthcarePartyRequestConfig(healthcarePartyId: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/hcparty/{healthcarePartyId}".replace(
                "{" + "healthcarePartyId" + "}",
                URLEncoder.encode(healthcarePartyId, Charsets.UTF_8)
            ),
            query = localVariableQuery,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getPublicKey(healthcarePartyId: String): PublicKeyDto {
     ...
     * @return RequestConfig
     */
    fun getPublicKeyRequestConfig(healthcarePartyId: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/hcparty/{healthcarePartyId}/publicKey".replace(
                "{" + "healthcarePartyId" + "}",
                URLEncoder.encode(healthcarePartyId, Charsets.UTF_8)
            ),
            query = localVariableQuery,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listHealthcarePartiesByName(name: String): List<HealthcarePartyDto> {
        val localVariableConfig = listHealthcarePartiesByNameRequestConfig(name = name)

        return request<Unit, List<HealthcarePartyDto>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun listHealthcarePartiesByNameRequestConfig(name: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/hcparty/byNameStrict/{name}".replace(
                "{" + "name" + "}",
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listHealthcarePartiesByParentId(parentId: String): List<HealthcarePartyDto> {
     ...
     * @return RequestConfig
     */
    fun listHealthcarePartiesByParentIdRequestConfig(parentId: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/hcparty/{parentId}/children".replace(
                "{" + "parentId" + "}",
                URLEncoder.encode(parentId, Charsets.UTF_8)
            ),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun matchHealthcarePartiesBy(abstractFilterDtoHealthcareParty: io.icure.kraken.client.models.filter.AbstractFilterDto<HealthcarePartyDto>): List<String> {
        val localVariableConfig =
            matchHealthcarePartiesByRequestConfig(abstractFilterDtoHealthcareParty = abstractFilterDtoHealthcareParty)

        return request<io.icure.kraken.client.models.filter.AbstractFilterDto<HealthcarePartyDto>, List<String>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun matchHealthcarePartiesByRequestConfig(abstractFilterDtoHealthcareParty: io.icure.kraken.client.models.filter.AbstractFilterDto<HealthcarePartyDto>): RequestConfig<io.icure.kraken.client.models.filter.AbstractFilterDto<HealthcarePartyDto>> {
    ...
    suspend fun modifyHealthcarePartyInGroup(
        ...
        val localVariableConfig =
            modifyHealthcarePartyInGroupRequestConfig(groupId = groupId, healthcarePartyDto = healthcarePartyDto)
     ...
     * @return RequestConfig
     */
    fun modifyHealthcarePartyInGroupRequestConfig(
        groupId: String,
        healthcarePartyDto: HealthcarePartyDto
    ): RequestConfig<HealthcarePartyDto> {
        // val localVariableBody = healthcarePartyDto
    ...
    suspend fun registerPatient1(
        ...
        val localVariableConfig = registerPatient1RequestConfig(
            groupId = groupId,
            healthcarePartyDto = healthcarePartyDto,
     ...
     * @return RequestConfig
     */
    fun registerPatient1RequestConfig(
        groupId: String,
        healthcarePartyDto: HealthcarePartyDto,
        parentHcPartyId: String?,
        token: String?,
        ...
        return RequestConfig(
            method = RequestMethod.POST,
            path = "/rest/v2/hcparty/register/inGroup/{groupId}".replace(
                "{" + "groupId" + "}",
                URLEncoder.encode(groupId, Charsets.UTF_8)
            ),
            query = localVariableQuery,
