...
class HealthcarePartyApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun filterHealthcarePartiesBy(filterChainHealthcareParty: FilterChainHealthcareParty, startDocumentId: kotlin.String?, limit: kotlin.Int?) : PaginatedListHealthcarePartyDto  {
