...
class HelementApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createHealthElement1(healthElementDto: HealthElementDto) : HealthElementDto?  {
        val localVariableConfig = createHealthElement1RequestConfig(healthElementDto = healthElementDto)
    ...
    /**
    * To obtain the request config of the operation createHealthElement1
    *
    * @param healthElementDto  
    * @return RequestConfig
    */
    fun createHealthElement1RequestConfig(healthElementDto: HealthElementDto) : RequestConfig<HealthElementDto> {
        val localVariableBody = healthElementDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createHealthElements1(healthElementDto: kotlin.collections.List<HealthElementDto>) : kotlin.collections.List<HealthElementDto>?  {
        val localVariableConfig = createHealthElements1RequestConfig(healthElementDto = healthElementDto)
    ...
    /**
    * To obtain the request config of the operation createHealthElements1
    *
    * @param healthElementDto  
    * @return RequestConfig
    */
    fun createHealthElements1RequestConfig(healthElementDto: kotlin.collections.List<HealthElementDto>) : RequestConfig<kotlin.collections.List<HealthElementDto>> {
        val localVariableBody = healthElementDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun deleteHealthElements1(healthElementIds: kotlin.String) : kotlin.collections.List<DocIdentifier>?  {
        val localVariableConfig = deleteHealthElements1RequestConfig(healthElementIds = healthElementIds)
    ...
    /**
    * To obtain the request config of the operation deleteHealthElements1
    *
    * @param healthElementIds  
    * @return RequestConfig
    */
    fun deleteHealthElements1RequestConfig(healthElementIds: kotlin.String) : RequestConfig<Unit> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun filterHealthElementsBy1(filterChainHealthElement: FilterChainHealthElement) : kotlin.collections.List<HealthElementDto>?  {
        val localVariableConfig = filterHealthElementsBy1RequestConfig(filterChainHealthElement = filterChainHealthElement)
    ...
    /**
    * To obtain the request config of the operation filterHealthElementsBy1
    *
    * @param filterChainHealthElement  
    * @return RequestConfig
    */
    fun filterHealthElementsBy1RequestConfig(filterChainHealthElement: FilterChainHealthElement) : RequestConfig<FilterChainHealthElement> {
        val localVariableBody = filterChainHealthElement
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getHealthElement1(healthElementId: kotlin.String) : HealthElementDto?  {
        val localVariableConfig = getHealthElement1RequestConfig(healthElementId = healthElementId)
    ...
    /**
    * To obtain the request config of the operation getHealthElement1
    *
    * @param healthElementId  
    * @return RequestConfig
    */
    fun getHealthElement1RequestConfig(healthElementId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyHealthElement1(healthElementDto: HealthElementDto) : HealthElementDto?  {
        val localVariableConfig = modifyHealthElement1RequestConfig(healthElementDto = healthElementDto)
    ...
    /**
    * To obtain the request config of the operation modifyHealthElement1
    *
    * @param healthElementDto  
    * @return RequestConfig
    */
    fun modifyHealthElement1RequestConfig(healthElementDto: HealthElementDto) : RequestConfig<HealthElementDto> {
        val localVariableBody = healthElementDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyHealthElements1(healthElementDto: kotlin.collections.List<HealthElementDto>) : kotlin.collections.List<HealthElementDto>?  {
        val localVariableConfig = modifyHealthElements1RequestConfig(healthElementDto = healthElementDto)
    ...
    /**
    * To obtain the request config of the operation modifyHealthElements1
    *
    * @param healthElementDto  
    * @return RequestConfig
    */
    fun modifyHealthElements1RequestConfig(healthElementDto: kotlin.collections.List<HealthElementDto>) : RequestConfig<kotlin.collections.List<HealthElementDto>> {
        val localVariableBody = healthElementDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun newHealthElementDelegations1(healthElementId: kotlin.String, delegationDto: kotlin.collections.List<DelegationDto>) : HealthElementDto?  {
        val localVariableConfig = newHealthElementDelegations1RequestConfig(healthElementId = healthElementId, delegationDto = delegationDto)
    ...
    /**
    * To obtain the request config of the operation newHealthElementDelegations1
    *
    * @param healthElementId  
    * @param delegationDto  
    * @return RequestConfig
    */
    fun newHealthElementDelegations1RequestConfig(healthElementId: kotlin.String, delegationDto: kotlin.collections.List<DelegationDto>) : RequestConfig<kotlin.collections.List<DelegationDto>> {
        val localVariableBody = delegationDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun setHealthElementsDelegations1(icureStubDto: kotlin.collections.List<IcureStubDto>) : kotlin.collections.List<HealthElementDto>?  {
        val localVariableConfig = setHealthElementsDelegations1RequestConfig(icureStubDto = icureStubDto)
    ...
    /**
    * To obtain the request config of the operation setHealthElementsDelegations1
    *
    * @param icureStubDto  
    * @return RequestConfig
    */
    fun setHealthElementsDelegations1RequestConfig(icureStubDto: kotlin.collections.List<IcureStubDto>) : RequestConfig<kotlin.collections.List<IcureStubDto>> {
        val localVariableBody = icureStubDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
