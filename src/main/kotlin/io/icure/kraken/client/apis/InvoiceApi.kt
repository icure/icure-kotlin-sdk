...
class InvoiceApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun appendCodes1(userId: kotlin.String, type: kotlin.String, sentMediumType: kotlin.String, secretFKeys: kotlin.String, invoicingCodeDto: kotlin.collections.List<InvoicingCodeDto>, insuranceId: kotlin.String?, invoiceId: kotlin.String?, gracePeriod: kotlin.Int?) : kotlin.collections.List<InvoiceDto>?  {
        val localVariableConfig = appendCodes1RequestConfig(userId = userId, type = type, sentMediumType = sentMediumType, secretFKeys = secretFKeys, invoicingCodeDto = invoicingCodeDto, insuranceId = insuranceId, invoiceId = invoiceId, gracePeriod = gracePeriod)
    ...
    /**
    * To obtain the request config of the operation appendCodes1
    *
    * @param userId  
    * @param type  
    * @param sentMediumType  
    ...
    * @return RequestConfig
    */
    fun appendCodes1RequestConfig(userId: kotlin.String, type: kotlin.String, sentMediumType: kotlin.String, secretFKeys: kotlin.String, invoicingCodeDto: kotlin.collections.List<InvoicingCodeDto>, insuranceId: kotlin.String?, invoiceId: kotlin.String?, gracePeriod: kotlin.Int?) : RequestConfig<kotlin.collections.List<InvoicingCodeDto>> {
        val localVariableBody = invoicingCodeDto
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                put("secretFKeys", listOf(secretFKeys.toString()))
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createInvoice1(invoiceDto: InvoiceDto) : InvoiceDto?  {
        val localVariableConfig = createInvoice1RequestConfig(invoiceDto = invoiceDto)
    ...
    /**
    * To obtain the request config of the operation createInvoice1
    *
    * @param invoiceDto  
    * @return RequestConfig
    */
    fun createInvoice1RequestConfig(invoiceDto: InvoiceDto) : RequestConfig<InvoiceDto> {
        val localVariableBody = invoiceDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createInvoices1(invoiceDto: kotlin.collections.List<InvoiceDto>) : kotlin.collections.List<InvoiceDto>?  {
        val localVariableConfig = createInvoices1RequestConfig(invoiceDto = invoiceDto)
    ...
    /**
    * To obtain the request config of the operation createInvoices1
    *
    * @param invoiceDto  
    * @return RequestConfig
    */
    fun createInvoices1RequestConfig(invoiceDto: kotlin.collections.List<InvoiceDto>) : RequestConfig<kotlin.collections.List<InvoiceDto>> {
        val localVariableBody = invoiceDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun deleteInvoice1(invoiceId: kotlin.String) : DocIdentifier?  {
        val localVariableConfig = deleteInvoice1RequestConfig(invoiceId = invoiceId)
    ...
    /**
    * To obtain the request config of the operation deleteInvoice1
    *
    * @param invoiceId  
    * @return RequestConfig
    */
    fun deleteInvoice1RequestConfig(invoiceId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun filterInvoicesBy1(filterChainInvoice: FilterChainInvoice) : kotlin.collections.List<InvoiceDto>?  {
        val localVariableConfig = filterInvoicesBy1RequestConfig(filterChainInvoice = filterChainInvoice)
    ...
    /**
    * To obtain the request config of the operation filterInvoicesBy1
    *
    * @param filterChainInvoice  
    * @return RequestConfig
    */
    fun filterInvoicesBy1RequestConfig(filterChainInvoice: FilterChainInvoice) : RequestConfig<FilterChainInvoice> {
        val localVariableBody = filterChainInvoice
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getInvoice1(invoiceId: kotlin.String) : InvoiceDto?  {
        val localVariableConfig = getInvoice1RequestConfig(invoiceId = invoiceId)
    ...
    /**
    * To obtain the request config of the operation getInvoice1
    *
    * @param invoiceId  
    * @return RequestConfig
    */
    fun getInvoice1RequestConfig(invoiceId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getInvoices1(listOfIdsDto: ListOfIdsDto) : kotlin.collections.List<InvoiceDto>?  {
        val localVariableConfig = getInvoices1RequestConfig(listOfIdsDto = listOfIdsDto)
    ...
    /**
    * To obtain the request config of the operation getInvoices1
    *
    * @param listOfIdsDto  
    * @return RequestConfig
    */
    fun getInvoices1RequestConfig(listOfIdsDto: ListOfIdsDto) : RequestConfig<ListOfIdsDto> {
        val localVariableBody = listOfIdsDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTarificationsCodesOccurences1(minOccurences: kotlin.Long) : kotlin.collections.List<LabelledOccurenceDto>?  {
        val localVariableConfig = getTarificationsCodesOccurences1RequestConfig(minOccurences = minOccurences)
    ...
    /**
    * To obtain the request config of the operation getTarificationsCodesOccurences1
    *
    * @param minOccurences  
    * @return RequestConfig
    */
    fun getTarificationsCodesOccurences1RequestConfig(minOccurences: kotlin.Long) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listAllHcpsByStatus1(status: kotlin.String, listOfIdsDto: ListOfIdsDto, from: kotlin.Long?, to: kotlin.Long?) : kotlin.collections.List<InvoiceDto>?  {
        val localVariableConfig = listAllHcpsByStatus1RequestConfig(status = status, listOfIdsDto = listOfIdsDto, from = from, to = to)
    ...
    /**
    * To obtain the request config of the operation listAllHcpsByStatus1
    *
    * @param status  
    * @param listOfIdsDto  
    * @param from  (optional)
    ...
    * @return RequestConfig
    */
    fun listAllHcpsByStatus1RequestConfig(status: kotlin.String, listOfIdsDto: ListOfIdsDto, from: kotlin.Long?, to: kotlin.Long?) : RequestConfig<ListOfIdsDto> {
        val localVariableBody = listOfIdsDto
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (from != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listInvoicesByAuthor(hcPartyId: kotlin.String, fromDate: kotlin.Long?, toDate: kotlin.Long?, startKey: kotlin.String?, startDocumentId: kotlin.String?, limit: kotlin.Int?) : PaginatedListInvoiceDto?  {
        val localVariableConfig = listInvoicesByAuthorRequestConfig(hcPartyId = hcPartyId, fromDate = fromDate, toDate = toDate, startKey = startKey, startDocumentId = startDocumentId, limit = limit)
    ...
    /**
    * To obtain the request config of the operation listInvoicesByAuthor
    *
    * @param hcPartyId  
    * @param fromDate  (optional)
    * @param toDate  (optional)
    ...
    * @return RequestConfig
    */
    fun listInvoicesByAuthorRequestConfig(hcPartyId: kotlin.String, fromDate: kotlin.Long?, toDate: kotlin.Long?, startKey: kotlin.String?, startDocumentId: kotlin.String?, limit: kotlin.Int?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (fromDate != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listToInsurances1(userIds: kotlin.String?) : kotlin.collections.List<InvoiceDto>?  {
        val localVariableConfig = listToInsurances1RequestConfig(userIds = userIds)
    ...
    /**
    * To obtain the request config of the operation listToInsurances1
    *
    * @param userIds  (optional)
    * @return RequestConfig
    */
    fun listToInsurances1RequestConfig(userIds: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (userIds != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listToInsurancesUnsent1(userIds: kotlin.String?) : kotlin.collections.List<InvoiceDto>?  {
        val localVariableConfig = listToInsurancesUnsent1RequestConfig(userIds = userIds)
    ...
    /**
    * To obtain the request config of the operation listToInsurancesUnsent1
    *
    * @param userIds  (optional)
    * @return RequestConfig
    */
    fun listToInsurancesUnsent1RequestConfig(userIds: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (userIds != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listToPatients1(hcPartyId: kotlin.String?) : kotlin.collections.List<InvoiceDto>?  {
        val localVariableConfig = listToPatients1RequestConfig(hcPartyId = hcPartyId)
    ...
    /**
    * To obtain the request config of the operation listToPatients1
    *
    * @param hcPartyId  (optional)
    * @return RequestConfig
    */
    fun listToPatients1RequestConfig(hcPartyId: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (hcPartyId != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listToPatientsUnsent1(hcPartyId: kotlin.String?) : kotlin.collections.List<InvoiceDto>?  {
        val localVariableConfig = listToPatientsUnsent1RequestConfig(hcPartyId = hcPartyId)
    ...
    /**
    * To obtain the request config of the operation listToPatientsUnsent1
    *
    * @param hcPartyId  (optional)
    * @return RequestConfig
    */
    fun listToPatientsUnsent1RequestConfig(hcPartyId: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (hcPartyId != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun mergeTo1(invoiceId: kotlin.String, listOfIdsDto: ListOfIdsDto) : InvoiceDto?  {
        val localVariableConfig = mergeTo1RequestConfig(invoiceId = invoiceId, listOfIdsDto = listOfIdsDto)
    ...
    /**
    * To obtain the request config of the operation mergeTo1
    *
    * @param invoiceId  
    * @param listOfIdsDto  
    * @return RequestConfig
    */
    fun mergeTo1RequestConfig(invoiceId: kotlin.String, listOfIdsDto: ListOfIdsDto) : RequestConfig<ListOfIdsDto> {
        val localVariableBody = listOfIdsDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyInvoice1(invoiceDto: InvoiceDto) : InvoiceDto?  {
        val localVariableConfig = modifyInvoice1RequestConfig(invoiceDto = invoiceDto)
    ...
    /**
    * To obtain the request config of the operation modifyInvoice1
    *
    * @param invoiceDto  
    * @return RequestConfig
    */
    fun modifyInvoice1RequestConfig(invoiceDto: InvoiceDto) : RequestConfig<InvoiceDto> {
        val localVariableBody = invoiceDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyInvoices1(invoiceDto: kotlin.collections.List<InvoiceDto>) : kotlin.collections.List<InvoiceDto>?  {
        val localVariableConfig = modifyInvoices1RequestConfig(invoiceDto = invoiceDto)
    ...
    /**
    * To obtain the request config of the operation modifyInvoices1
    *
    * @param invoiceDto  
    * @return RequestConfig
    */
    fun modifyInvoices1RequestConfig(invoiceDto: kotlin.collections.List<InvoiceDto>) : RequestConfig<kotlin.collections.List<InvoiceDto>> {
        val localVariableBody = invoiceDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun newInvoiceDelegations1(invoiceId: kotlin.String, delegationDto: kotlin.collections.List<DelegationDto>) : InvoiceDto?  {
        val localVariableConfig = newInvoiceDelegations1RequestConfig(invoiceId = invoiceId, delegationDto = delegationDto)
    ...
    /**
    * To obtain the request config of the operation newInvoiceDelegations1
    *
    * @param invoiceId  
    * @param delegationDto  
    * @return RequestConfig
    */
    fun newInvoiceDelegations1RequestConfig(invoiceId: kotlin.String, delegationDto: kotlin.collections.List<DelegationDto>) : RequestConfig<kotlin.collections.List<DelegationDto>> {
        val localVariableBody = delegationDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun reassignInvoice1(invoiceDto: InvoiceDto) : InvoiceDto?  {
        val localVariableConfig = reassignInvoice1RequestConfig(invoiceDto = invoiceDto)
    ...
    /**
    * To obtain the request config of the operation reassignInvoice1
    *
    * @param invoiceDto  
    * @return RequestConfig
    */
    fun reassignInvoice1RequestConfig(invoiceDto: InvoiceDto) : RequestConfig<InvoiceDto> {
        val localVariableBody = invoiceDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun removeCodes1(userId: kotlin.String, serviceId: kotlin.String, secretFKeys: kotlin.String, requestBody: kotlin.collections.List<kotlin.String>) : kotlin.collections.List<InvoiceDto>?  {
        val localVariableConfig = removeCodes1RequestConfig(userId = userId, serviceId = serviceId, secretFKeys = secretFKeys, requestBody = requestBody)
    ...
    /**
    * To obtain the request config of the operation removeCodes1
    *
    * @param userId  
    * @param serviceId  
    * @param secretFKeys  
    ...
    * @return RequestConfig
    */
    fun removeCodes1RequestConfig(userId: kotlin.String, serviceId: kotlin.String, secretFKeys: kotlin.String, requestBody: kotlin.collections.List<kotlin.String>) : RequestConfig<kotlin.collections.List<kotlin.String>> {
        val localVariableBody = requestBody
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                put("secretFKeys", listOf(secretFKeys.toString()))
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun setInvoicesDelegations1(icureStubDto: kotlin.collections.List<IcureStubDto>) : kotlin.collections.List<IcureStubDto>?  {
        val localVariableConfig = setInvoicesDelegations1RequestConfig(icureStubDto = icureStubDto)
    ...
    /**
    * To obtain the request config of the operation setInvoicesDelegations1
    *
    * @param icureStubDto  
    * @return RequestConfig
    */
    fun setInvoicesDelegations1RequestConfig(icureStubDto: kotlin.collections.List<IcureStubDto>) : RequestConfig<kotlin.collections.List<IcureStubDto>> {
        val localVariableBody = icureStubDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun validate1(invoiceId: kotlin.String, scheme: kotlin.String, forcedValue: kotlin.String) : InvoiceDto?  {
        val localVariableConfig = validate1RequestConfig(invoiceId = invoiceId, scheme = scheme, forcedValue = forcedValue)
    ...
    /**
    * To obtain the request config of the operation validate1
    *
    * @param invoiceId  
    * @param scheme  
    * @param forcedValue  
    * @return RequestConfig
    */
    fun validate1RequestConfig(invoiceId: kotlin.String, scheme: kotlin.String, forcedValue: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                put("scheme", listOf(scheme.toString()))
