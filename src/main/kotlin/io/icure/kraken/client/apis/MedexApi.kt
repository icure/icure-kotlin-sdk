...
class MedexApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun generateMedex1(medexInfoDto: MedexInfoDto) : kotlin.String?  {
        val localVariableConfig = generateMedex1RequestConfig(medexInfoDto = medexInfoDto)
    ...
    /**
    * To obtain the request config of the operation generateMedex1
    *
    * @param medexInfoDto  
    * @return RequestConfig
    */
    fun generateMedex1RequestConfig(medexInfoDto: MedexInfoDto) : RequestConfig<MedexInfoDto> {
        val localVariableBody = medexInfoDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
