...
class MedicalLocationApi(
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun deleteMedicalLocations(listOfIdsDto: ListOfIdsDto): List<DocIdentifier> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getMedicalLocation(locationId: String): MedicalLocationDto {
     ...
     * @return RequestConfig
     */
    fun getMedicalLocationRequestConfig(locationId: String): RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/rest/v2/medicallocation/{locationId}".replace(
                "{" + "locationId" + "}",
                URLEncoder.encode(locationId, Charsets.UTF_8)
            ),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getMedicalLocations(): List<MedicalLocationDto> {
        val localVariableConfig = getMedicalLocationsRequestConfig()

        return request<Unit, List<MedicalLocationDto>>(
            localVariableConfig
        )!!
    }
