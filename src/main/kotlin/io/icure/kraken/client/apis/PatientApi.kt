...
import io.icure.kraken.client.models.PaginatedListSerializable
...
class PatientApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun countOfPatients1(hcPartyId: kotlin.String) : ContentDto?  {
        val localVariableConfig = countOfPatients1RequestConfig(hcPartyId = hcPartyId)
    ...
    /**
    * To obtain the request config of the operation countOfPatients1
    *
    * @param hcPartyId Healthcare party id 
    * @return RequestConfig
    */
    fun countOfPatients1RequestConfig(hcPartyId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createPatient1(patientDto: PatientDto) : PatientDto?  {
        val localVariableConfig = createPatient1RequestConfig(patientDto = patientDto)
    ...
    /**
    * To obtain the request config of the operation createPatient1
    *
    * @param patientDto  
    * @return RequestConfig
    */
    fun createPatient1RequestConfig(patientDto: PatientDto) : RequestConfig<PatientDto> {
        val localVariableBody = patientDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun filterPatientsBy1(filterChainPatient: FilterChainPatient, startKey: kotlin.String?, startDocumentId: kotlin.String?, limit: kotlin.Int?, skip: kotlin.Int?, sort: kotlin.String?, desc: kotlin.Boolean?) : PaginatedListPatientDto?  {
        val localVariableConfig = filterPatientsBy1RequestConfig(filterChainPatient = filterChainPatient, startKey = startKey, startDocumentId = startDocumentId, limit = limit, skip = skip, sort = sort, desc = desc)
    ...
    /**
    * To obtain the request config of the operation filterPatientsBy1
    *
    * @param filterChainPatient  
    * @param startKey The start key for pagination, depends on the filters used (optional)
    * @param startDocumentId A patient document ID (optional)
    ...
    * @return RequestConfig
    */
    fun filterPatientsBy1RequestConfig(filterChainPatient: FilterChainPatient, startKey: kotlin.String?, startDocumentId: kotlin.String?, limit: kotlin.Int?, skip: kotlin.Int?, sort: kotlin.String?, desc: kotlin.Boolean?) : RequestConfig<FilterChainPatient> {
        val localVariableBody = filterChainPatient
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (startKey != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun findByExternalId1(externalId: kotlin.String) : PatientDto?  {
        val localVariableConfig = findByExternalId1RequestConfig(externalId = externalId)
    ...
    /**
    * To obtain the request config of the operation findByExternalId1
    *
    * @param externalId A external ID 
    * @return RequestConfig
    */
    fun findByExternalId1RequestConfig(externalId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    * @param limit Number of rows (optional)
    * @param sortDirection Optional value for providing a sorting direction (&#39;asc&#39;, &#39;desc&#39;). Set to &#39;asc&#39; by default. (optional, default to "asc")
    * @return PaginatedListSerializable
    * @throws UnsupportedOperationException If the API returns an informational or redirection response
    * @throws ClientException If the API returns a client error response
    * @throws ServerException If the API returns a server error response
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun findPatientsByNameBirthSsinAuto(healthcarePartyId: kotlin.String?, filterValue: kotlin.String?, startKey: kotlin.String?, startDocumentId: kotlin.String?, limit: kotlin.Int?, sortDirection: kotlin.String?) : PaginatedListSerializable?  {
        ...
        return request<Unit, PaginatedListSerializable>(
            localVariableConfig
        )
    }
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun fuzzySearch1(firstName: kotlin.String?, lastName: kotlin.String?, dateOfBirth: kotlin.Int?) : kotlin.collections.List<PatientDto>?  {
        val localVariableConfig = fuzzySearch1RequestConfig(firstName = firstName, lastName = lastName, dateOfBirth = dateOfBirth)
    ...
    /**
    * To obtain the request config of the operation fuzzySearch1
    *
    * @param firstName The first name (optional)
    * @param lastName The last name (optional)
    * @param dateOfBirth The date of birth (optional)
    * @return RequestConfig
    */
    fun fuzzySearch1RequestConfig(firstName: kotlin.String?, lastName: kotlin.String?, dateOfBirth: kotlin.Int?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (firstName != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getPatient1(patientId: kotlin.String) : PatientDto?  {
        val localVariableConfig = getPatient1RequestConfig(patientId = patientId)
    ...
    /**
    * To obtain the request config of the operation getPatient1
    *
    * @param patientId  
    * @return RequestConfig
    */
    fun getPatient1RequestConfig(patientId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getPatientHcPartyKeysForDelegate1(patientId: kotlin.String) : kotlin.String?  {
        val localVariableConfig = getPatientHcPartyKeysForDelegate1RequestConfig(patientId = patientId)
    ...
    /**
    * To obtain the request config of the operation getPatientHcPartyKeysForDelegate1
    *
    * @param patientId The patient Id for which information is shared 
    * @return RequestConfig
    */
    fun getPatientHcPartyKeysForDelegate1RequestConfig(patientId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getPatients1(listOfIdsDto: ListOfIdsDto) : kotlin.collections.List<PatientDto>?  {
        val localVariableConfig = getPatients1RequestConfig(listOfIdsDto = listOfIdsDto)
    ...
    /**
    * To obtain the request config of the operation getPatients1
    *
    * @param listOfIdsDto  
    * @return RequestConfig
    */
    fun getPatients1RequestConfig(listOfIdsDto: ListOfIdsDto) : RequestConfig<ListOfIdsDto> {
        val localVariableBody = listOfIdsDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listDeletedPatientsByName1(firstName: kotlin.String?, lastName: kotlin.String?) : kotlin.collections.List<PatientDto>?  {
        val localVariableConfig = listDeletedPatientsByName1RequestConfig(firstName = firstName, lastName = lastName)
    ...
    /**
    * To obtain the request config of the operation listDeletedPatientsByName1
    *
    * @param firstName First name prefix (optional)
    * @param lastName Last name prefix (optional)
    * @return RequestConfig
    */
    fun listDeletedPatientsByName1RequestConfig(firstName: kotlin.String?, lastName: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (firstName != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listOfMergesAfter1(date: kotlin.Long) : kotlin.collections.List<PatientDto>?  {
        val localVariableConfig = listOfMergesAfter1RequestConfig(date = date)
    ...
    /**
    * To obtain the request config of the operation listOfMergesAfter1
    *
    * @param date  
    * @return RequestConfig
    */
    fun listOfMergesAfter1RequestConfig(date: kotlin.Long) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun matchPatientsBy1(abstractFilterDtoPatient: io.icure.kraken.client.models.filter.AbstractFilterDto<io.icure.kraken.client.models.PatientDto>) : kotlin.collections.List<kotlin.String>?  {
        val localVariableConfig = matchPatientsBy1RequestConfig(abstractFilterDtoPatient = abstractFilterDtoPatient)
    ...
    /**
    * To obtain the request config of the operation matchPatientsBy1
    *
    * @param abstractFilterDtoPatient  
    * @return RequestConfig
    */
    fun matchPatientsBy1RequestConfig(abstractFilterDtoPatient: io.icure.kraken.client.models.filter.AbstractFilterDto<io.icure.kraken.client.models.PatientDto>) : RequestConfig<io.icure.kraken.client.models.filter.AbstractFilterDto<io.icure.kraken.client.models.PatientDto>> {
        val localVariableBody = abstractFilterDtoPatient
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun mergeInto1(toId: kotlin.String, fromIds: kotlin.String) : PatientDto?  {
        val localVariableConfig = mergeInto1RequestConfig(toId = toId, fromIds = fromIds)
    ...
    /**
    * To obtain the request config of the operation mergeInto1
    *
    * @param toId  
    * @param fromIds  
    * @return RequestConfig
    */
    fun mergeInto1RequestConfig(toId: kotlin.String, fromIds: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyPatient1(patientDto: PatientDto) : PatientDto?  {
        val localVariableConfig = modifyPatient1RequestConfig(patientDto = patientDto)
    ...
    /**
    * To obtain the request config of the operation modifyPatient1
    *
    * @param patientDto  
    * @return RequestConfig
    */
    fun modifyPatient1RequestConfig(patientDto: PatientDto) : RequestConfig<PatientDto> {
        val localVariableBody = patientDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyPatientReferral1(patientId: kotlin.String, referralId: kotlin.String, start: kotlin.Long?, end: kotlin.Long?) : PatientDto?  {
        val localVariableConfig = modifyPatientReferral1RequestConfig(patientId = patientId, referralId = referralId, start = start, end = end)
    ...
    /**
    * To obtain the request config of the operation modifyPatientReferral1
    *
    * @param patientId  
    * @param referralId The referal id. Accepts &#39;none&#39; for referral removal. 
    * @param start Optional value for start of referral (optional)
    ...
    * @return RequestConfig
    */
    fun modifyPatientReferral1RequestConfig(patientId: kotlin.String, referralId: kotlin.String, start: kotlin.Long?, end: kotlin.Long?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (start != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun newPatientDelegations1(patientId: kotlin.String, delegationDto: kotlin.collections.List<DelegationDto>) : PatientDto?  {
        val localVariableConfig = newPatientDelegations1RequestConfig(patientId = patientId, delegationDto = delegationDto)
    ...
    /**
    * To obtain the request config of the operation newPatientDelegations1
    *
    * @param patientId  
    * @param delegationDto  
    * @return RequestConfig
    */
    fun newPatientDelegations1RequestConfig(patientId: kotlin.String, delegationDto: kotlin.collections.List<DelegationDto>) : RequestConfig<kotlin.collections.List<DelegationDto>> {
        val localVariableBody = delegationDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun undeletePatient1(patientIds: kotlin.String) : kotlin.collections.List<DocIdentifier>?  {
        val localVariableConfig = undeletePatient1RequestConfig(patientIds = patientIds)
    ...
    /**
    * To obtain the request config of the operation undeletePatient1
    *
    * @param patientIds  
    * @return RequestConfig
    */
    fun undeletePatient1RequestConfig(patientIds: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
