...
import io.icure.kraken.client.IPatientApi
...
class PatientApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader),
    ...
    * @return RequestConfig
    */
    fun matchPatientsByRequestConfig(abstractFilterDtoPatient: AbstractFilterDtoPatient) : RequestConfig<AbstractFilterDtoPatient> {
