...
class PlaceApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createPlace1(placeDto: PlaceDto) : PlaceDto?  {
        val localVariableConfig = createPlace1RequestConfig(placeDto = placeDto)
    ...
    /**
    * To obtain the request config of the operation createPlace1
    *
    * @param placeDto  
    * @return RequestConfig
    */
    fun createPlace1RequestConfig(placeDto: PlaceDto) : RequestConfig<PlaceDto> {
        val localVariableBody = placeDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getPlace1(placeId: kotlin.String) : PlaceDto?  {
        val localVariableConfig = getPlace1RequestConfig(placeId = placeId)
    ...
    /**
    * To obtain the request config of the operation getPlace1
    *
    * @param placeId  
    * @return RequestConfig
    */
    fun getPlace1RequestConfig(placeId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getPlaces1() : kotlin.collections.List<PlaceDto>?  {
        val localVariableConfig = getPlaces1RequestConfig()
    ...
    /**
    * To obtain the request config of the operation getPlaces1
    *
    * @return RequestConfig
    */
    fun getPlaces1RequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyPlace1(placeDto: PlaceDto) : PlaceDto?  {
        val localVariableConfig = modifyPlace1RequestConfig(placeDto = placeDto)
    ...
    /**
    * To obtain the request config of the operation modifyPlace1
    *
    * @param placeDto  
    * @return RequestConfig
    */
    fun modifyPlace1RequestConfig(placeDto: PlaceDto) : RequestConfig<PlaceDto> {
        val localVariableBody = placeDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
