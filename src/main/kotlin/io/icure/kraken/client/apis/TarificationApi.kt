...
class TarificationApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createTarification1(tarificationDto: TarificationDto) : TarificationDto?  {
        val localVariableConfig = createTarification1RequestConfig(tarificationDto = tarificationDto)
    ...
    /**
    * To obtain the request config of the operation createTarification1
    *
    * @param tarificationDto  
    * @return RequestConfig
    */
    fun createTarification1RequestConfig(tarificationDto: TarificationDto) : RequestConfig<TarificationDto> {
        val localVariableBody = tarificationDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTarification1(tarificationId: kotlin.String) : TarificationDto?  {
        val localVariableConfig = getTarification1RequestConfig(tarificationId = tarificationId)
    ...
    /**
    * To obtain the request config of the operation getTarification1
    *
    * @param tarificationId Tarification id 
    * @return RequestConfig
    */
    fun getTarification1RequestConfig(tarificationId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTarificationWithParts1(type: kotlin.String, tarification: kotlin.String, version: kotlin.String) : TarificationDto?  {
        val localVariableConfig = getTarificationWithParts1RequestConfig(type = type, tarification = tarification, version = version)
    ...
    /**
    * To obtain the request config of the operation getTarificationWithParts1
    *
    * @param type Tarification type 
    * @param tarification Tarification tarification 
    * @param version Tarification version 
    * @return RequestConfig
    */
    fun getTarificationWithParts1RequestConfig(type: kotlin.String, tarification: kotlin.String, version: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTarifications1(listOfIdsDto: ListOfIdsDto) : kotlin.collections.List<TarificationDto>?  {
        val localVariableConfig = getTarifications1RequestConfig(listOfIdsDto = listOfIdsDto)
    ...
    /**
    * To obtain the request config of the operation getTarifications1
    *
    * @param listOfIdsDto  
    * @return RequestConfig
    */
    fun getTarifications1RequestConfig(listOfIdsDto: ListOfIdsDto) : RequestConfig<ListOfIdsDto> {
        val localVariableBody = listOfIdsDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyTarification1(tarificationDto: TarificationDto) : TarificationDto?  {
        val localVariableConfig = modifyTarification1RequestConfig(tarificationDto = tarificationDto)
    ...
    /**
    * To obtain the request config of the operation modifyTarification1
    *
    * @param tarificationDto  
    * @return RequestConfig
    */
    fun modifyTarification1RequestConfig(tarificationDto: TarificationDto) : RequestConfig<TarificationDto> {
        val localVariableBody = tarificationDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
