...
class TmpApi(
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createTmpClassifications(classificationDto: List<ClassificationDto>): List<ClassificationDto> {
        val localVariableConfig = createTmpClassificationsRequestConfig(classificationDto = classificationDto)

        return request<List<ClassificationDto>, List<ClassificationDto>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun createTmpClassificationsRequestConfig(classificationDto: List<ClassificationDto>): RequestConfig<List<ClassificationDto>> {
        // val localVariableBody = classificationDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createTmpContacts(contactDto: List<ContactDto>): List<ContactDto> {
     ...
     * @return RequestConfig
     */
    fun createTmpContactsRequestConfig(contactDto: List<ContactDto>): RequestConfig<List<ContactDto>> {
        // val localVariableBody = contactDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createTmpDatabase(): Any {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createTmpDocuments(documentDto: List<DocumentDto>): List<DocumentDto> {
     ...
     * @return RequestConfig
     */
    fun createTmpDocumentsRequestConfig(documentDto: List<DocumentDto>): RequestConfig<List<DocumentDto>> {
        // val localVariableBody = documentDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createTmpEntityTemplates(entityTemplateDto: List<EntityTemplateDto>): List<EntityTemplateDto> {
        val localVariableConfig = createTmpEntityTemplatesRequestConfig(entityTemplateDto = entityTemplateDto)

        return request<List<EntityTemplateDto>, List<EntityTemplateDto>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun createTmpEntityTemplatesRequestConfig(entityTemplateDto: List<EntityTemplateDto>): RequestConfig<List<EntityTemplateDto>> {
        // val localVariableBody = entityTemplateDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createTmpForms(formDto: List<FormDto>): List<FormDto> {
     ...
     * @return RequestConfig
     */
    fun createTmpFormsRequestConfig(formDto: List<FormDto>): RequestConfig<List<FormDto>> {
        // val localVariableBody = formDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createTmpHealthElements(healthElementDto: List<HealthElementDto>): List<HealthElementDto> {
     ...
     * @return RequestConfig
     */
    fun createTmpHealthElementsRequestConfig(healthElementDto: List<HealthElementDto>): RequestConfig<List<HealthElementDto>> {
        // val localVariableBody = healthElementDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createTmpInvoices(invoiceDto: List<InvoiceDto>): List<InvoiceDto> {
     ...
     * @return RequestConfig
     */
    fun createTmpInvoicesRequestConfig(invoiceDto: List<InvoiceDto>): RequestConfig<List<InvoiceDto>> {
        // val localVariableBody = invoiceDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createTmpMessages(messageDto: List<MessageDto>): List<MessageDto> {
        val localVariableConfig = createTmpMessagesRequestConfig(messageDto = messageDto)

        return request<List<MessageDto>, List<MessageDto>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun createTmpMessagesRequestConfig(messageDto: List<MessageDto>): RequestConfig<List<MessageDto>> {
        // val localVariableBody = messageDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createTmpPatients(patientDto: List<PatientDto>): List<PatientDto> {
        val localVariableConfig = createTmpPatientsRequestConfig(patientDto = patientDto)

        return request<List<PatientDto>, List<PatientDto>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun createTmpPatientsRequestConfig(patientDto: List<PatientDto>): RequestConfig<List<PatientDto>> {
        // val localVariableBody = patientDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun deleteTmpItems(requestBody: List<String>): List<DocIdentifier> {
        val localVariableConfig = deleteTmpItemsRequestConfig(requestBody = requestBody)

        return request<List<String>, List<DocIdentifier>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun deleteTmpItemsRequestConfig(requestBody: List<String>): RequestConfig<List<String>> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun destroyTmpDatabase(): Any {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpClassification(id: String): ClassificationDto {
     ...
     * @return RequestConfig
     */
    fun getTmpClassificationRequestConfig(id: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            ...
            path = "/rest/v2/tmp/classification/byId/{id}".replace(
                "{" + "id" + "}",
                "${URLEncoder.encode(id.toString(), Charsets.UTF_8)}"
            ),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpClassifications(requestBody: List<String>): List<ClassificationDto> {
        val localVariableConfig = getTmpClassificationsRequestConfig(requestBody = requestBody)

        return request<List<String>, List<ClassificationDto>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun getTmpClassificationsRequestConfig(requestBody: List<String>): RequestConfig<List<String>> {
        // val localVariableBody = requestBody
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpContact(id: String): ContactDto {
     ...
     * @return RequestConfig
     */
    fun getTmpContactRequestConfig(id: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/tmp/contact/byId/{id}".replace(
                "{" + "id" + "}",
                "${URLEncoder.encode(id.toString(), Charsets.UTF_8)}"
            ),
            query = localVariableQuery,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpContacts(requestBody: List<String>): List<ContactDto> {
        val localVariableConfig = getTmpContactsRequestConfig(requestBody = requestBody)

        return request<List<String>, List<ContactDto>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun getTmpContactsRequestConfig(requestBody: List<String>): RequestConfig<List<String>> {
        // val localVariableBody = requestBody
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpDocument(id: String): DocumentDto {
     ...
     * @return RequestConfig
     */
    fun getTmpDocumentRequestConfig(id: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/tmp/document/byId/{id}".replace(
                "{" + "id" + "}",
                "${URLEncoder.encode(id.toString(), Charsets.UTF_8)}"
            ),
            query = localVariableQuery,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpDocuments(requestBody: List<String>): List<DocumentDto> {
        val localVariableConfig = getTmpDocumentsRequestConfig(requestBody = requestBody)

        return request<List<String>, List<DocumentDto>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun getTmpDocumentsRequestConfig(requestBody: List<String>): RequestConfig<List<String>> {
        // val localVariableBody = requestBody
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpEntityTemplate(id: String): EntityTemplateDto {
     ...
     * @return RequestConfig
     */
    fun getTmpEntityTemplateRequestConfig(id: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/tmp/entityTemplate/byId/{id}".replace(
                "{" + "id" + "}",
                "${URLEncoder.encode(id.toString(), Charsets.UTF_8)}"
            ),
            query = localVariableQuery,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpEntityTemplates(requestBody: List<String>): List<EntityTemplateDto> {
        val localVariableConfig = getTmpEntityTemplatesRequestConfig(requestBody = requestBody)

        return request<List<String>, List<EntityTemplateDto>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun getTmpEntityTemplatesRequestConfig(requestBody: List<String>): RequestConfig<List<String>> {
        // val localVariableBody = requestBody
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpForm(id: String): FormDto {
     ...
     * @return RequestConfig
     */
    fun getTmpFormRequestConfig(id: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/tmp/form/byId/{id}".replace(
                "{" + "id" + "}",
                "${URLEncoder.encode(id.toString(), Charsets.UTF_8)}"
            ),
            query = localVariableQuery,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpForms(requestBody: List<String>): List<FormDto> {
        val localVariableConfig = getTmpFormsRequestConfig(requestBody = requestBody)

        return request<List<String>, List<FormDto>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun getTmpFormsRequestConfig(requestBody: List<String>): RequestConfig<List<String>> {
        // val localVariableBody = requestBody
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpHealthElement(id: String): HealthElementDto {
     ...
     * @return RequestConfig
     */
    fun getTmpHealthElementRequestConfig(id: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/tmp/healthElement/byId/{id}".replace(
                "{" + "id" + "}",
                "${URLEncoder.encode(id.toString(), Charsets.UTF_8)}"
            ),
            query = localVariableQuery,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpHealthElements(requestBody: List<String>): List<HealthElementDto> {
        val localVariableConfig = getTmpHealthElementsRequestConfig(requestBody = requestBody)

        return request<List<String>, List<HealthElementDto>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun getTmpHealthElementsRequestConfig(requestBody: List<String>): RequestConfig<List<String>> {
        // val localVariableBody = requestBody
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpInvoice(id: String): InvoiceDto {
     ...
     * @return RequestConfig
     */
    fun getTmpInvoiceRequestConfig(id: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/tmp/invoice/byId/{id}".replace(
                "{" + "id" + "}",
                "${URLEncoder.encode(id.toString(), Charsets.UTF_8)}"
            ),
            query = localVariableQuery,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpInvoices(requestBody: List<String>): List<InvoiceDto> {
     ...
     * @return RequestConfig
     */
    fun getTmpInvoicesRequestConfig(requestBody: List<String>): RequestConfig<List<String>> {
        // val localVariableBody = requestBody
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpMessage(id: String): MessageDto {
     ...
     * @return RequestConfig
     */
    fun getTmpMessageRequestConfig(id: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/tmp/message/byId/{id}".replace(
                "{" + "id" + "}",
                "${URLEncoder.encode(id.toString(), Charsets.UTF_8)}"
            ),
            query = localVariableQuery,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpMessages(requestBody: List<String>): List<MessageDto> {
        val localVariableConfig = getTmpMessagesRequestConfig(requestBody = requestBody)

        return request<List<String>, List<MessageDto>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun getTmpMessagesRequestConfig(requestBody: List<String>): RequestConfig<List<String>> {
        // val localVariableBody = requestBody
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpPatient(id: String): PatientDto {
     ...
     * @return RequestConfig
     */
    fun getTmpPatientRequestConfig(id: String): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "*/*"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v2/tmp/patient/byId/{id}".replace(
                "{" + "id" + "}",
                "${URLEncoder.encode(id.toString(), Charsets.UTF_8)}"
            ),
            query = localVariableQuery,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTmpPatients(requestBody: List<String>): List<PatientDto> {
        val localVariableConfig = getTmpPatientsRequestConfig(requestBody = requestBody)

        return request<List<String>, List<PatientDto>>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun getTmpPatientsRequestConfig(requestBody: List<String>): RequestConfig<List<String>> {
        // val localVariableBody = requestBody
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    suspend fun listTmpClassifications(
        ...
        val localVariableConfig =
            listTmpClassificationsRequestConfig(firstClassificationId = firstClassificationId, pageSize = pageSize)
     ...
     * @return RequestConfig
     */
    fun listTmpClassificationsRequestConfig(
        firstClassificationId: String?,
        pageSize: Int?
    ): RequestConfig<Unit> {
        // val localVariableBody = null
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listTmpContacts(firstContactId: String?, pageSize: Int?): PaginatedListInvoiceDto {
     ...
     * @return RequestConfig
     */
    fun listTmpContactsRequestConfig(firstContactId: String?, pageSize: Int?): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<String, List<String>>()
            .apply {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listTmpDocuments(firstDocumentId: String?, pageSize: Int?): PaginatedListDocumentDto {
     ...
     * @return RequestConfig
     */
    fun listTmpDocumentsRequestConfig(firstDocumentId: String?, pageSize: Int?): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<String, List<String>>()
            .apply {
    ...
    suspend fun listTmpEntityTemplates(
        ...
        val localVariableConfig =
            listTmpEntityTemplatesRequestConfig(firstEntityTemplateId = firstEntityTemplateId, pageSize = pageSize)
     ...
     * @return RequestConfig
     */
    fun listTmpEntityTemplatesRequestConfig(
        firstEntityTemplateId: String?,
        pageSize: Int?
    ): RequestConfig<Unit> {
        // val localVariableBody = null
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listTmpForms(firstFormId: String?, pageSize: Int?): PaginatedListFormDto {
     ...
     * @return RequestConfig
     */
    fun listTmpFormsRequestConfig(firstFormId: String?, pageSize: Int?): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<String, List<String>>()
            .apply {
                if (firstFormId != null) {
    ...
    suspend fun listTmpHealthElements(
        ...
        val localVariableConfig =
            listTmpHealthElementsRequestConfig(firstHealthElementId = firstHealthElementId, pageSize = pageSize)
     ...
     * @return RequestConfig
     */
    fun listTmpHealthElementsRequestConfig(
        firstHealthElementId: String?,
        pageSize: Int?
    ): RequestConfig<Unit> {
        // val localVariableBody = null
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listTmpInvoices(firstInvoiceId: String?, pageSize: Int?): PaginatedListInvoiceDto {
     ...
     * @return RequestConfig
     */
    fun listTmpInvoicesRequestConfig(firstInvoiceId: String?, pageSize: Int?): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<String, List<String>>()
            .apply {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listTmpMessages(firstMessageId: String?, pageSize: Int?): PaginatedListInvoiceDto {
     ...
     * @return RequestConfig
     */
    fun listTmpMessagesRequestConfig(firstMessageId: String?, pageSize: Int?): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<String, List<String>>()
            .apply {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listTmpPatients(firstPatientId: String?, pageSize: Int?): PaginatedListPatientDto {
     ...
     * @return RequestConfig
     */
    fun listTmpPatientsRequestConfig(firstPatientId: String?, pageSize: Int?): RequestConfig<Unit> {
        // val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<String, List<String>>()
            .apply {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyTmpClassifications(classificationDto: List<ClassificationDto>): List<ClassificationDto> {
     ...
     * @return RequestConfig
     */
    fun modifyTmpClassificationsRequestConfig(classificationDto: List<ClassificationDto>): RequestConfig<List<ClassificationDto>> {
        // val localVariableBody = classificationDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyTmpContacts(contactDto: List<ContactDto>): List<ContactDto> {
     ...
     * @return RequestConfig
     */
    fun modifyTmpContactsRequestConfig(contactDto: List<ContactDto>): RequestConfig<List<ContactDto>> {
        // val localVariableBody = contactDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyTmpDocuments(documentDto: List<DocumentDto>): List<DocumentDto> {
     ...
     * @return RequestConfig
     */
    fun modifyTmpDocumentsRequestConfig(documentDto: List<DocumentDto>): RequestConfig<List<DocumentDto>> {
        // val localVariableBody = documentDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyTmpEntityTemplates(entityTemplateDto: List<EntityTemplateDto>): List<EntityTemplateDto> {
     ...
     * @return RequestConfig
     */
    fun modifyTmpEntityTemplatesRequestConfig(entityTemplateDto: List<EntityTemplateDto>): RequestConfig<List<EntityTemplateDto>> {
        // val localVariableBody = entityTemplateDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyTmpForms(formDto: List<FormDto>): List<FormDto> {
     ...
     * @return RequestConfig
     */
    fun modifyTmpFormsRequestConfig(formDto: List<FormDto>): RequestConfig<List<FormDto>> {
        // val localVariableBody = formDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyTmpHealthElements(healthElementDto: List<HealthElementDto>): List<HealthElementDto> {
     ...
     * @return RequestConfig
     */
    fun modifyTmpHealthElementsRequestConfig(healthElementDto: List<HealthElementDto>): RequestConfig<List<HealthElementDto>> {
        // val localVariableBody = healthElementDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyTmpInvoices(invoiceDto: List<InvoiceDto>): List<InvoiceDto> {
     ...
     * @return RequestConfig
     */
    fun modifyTmpInvoicesRequestConfig(invoiceDto: List<InvoiceDto>): RequestConfig<List<InvoiceDto>> {
        // val localVariableBody = invoiceDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyTmpMessages(messageDto: List<MessageDto>): List<MessageDto> {
     ...
     * @return RequestConfig
     */
    fun modifyTmpMessagesRequestConfig(messageDto: List<MessageDto>): RequestConfig<List<MessageDto>> {
        // val localVariableBody = messageDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun modifyTmpPatients(patientDto: List<PatientDto>): List<PatientDto> {
     ...
     * @return RequestConfig
     */
    fun modifyTmpPatientsRequestConfig(patientDto: List<PatientDto>): RequestConfig<List<PatientDto>> {
        // val localVariableBody = patientDto
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun purgeTmpItems(requestBody: List<String>): List<DocIdentifier> {
     ...
     * @return RequestConfig
     */
    fun purgeTmpItemsRequestConfig(requestBody: List<String>): RequestConfig<List<String>> {
        // val localVariableBody = requestBody
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "*/*"
    ...
    suspend fun replicateToTmpDatabase(
        ...
        return request<List<String>, ReplicatorDocumentDto>(
            localVariableConfig
        )!!
    }
     ...
     * @return RequestConfig
     */
    fun replicateToTmpDatabaseRequestConfig(
        from: String,
        requestBody: List<String>
        ...
        return RequestConfig(
            method = RequestMethod.POST,
            path = "/rest/v2/tmp/replicate/from/{from}".replace(
                "{" + "from" + "}",
                "${URLEncoder.encode(from.toString(), Charsets.UTF_8)}"
            ),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
