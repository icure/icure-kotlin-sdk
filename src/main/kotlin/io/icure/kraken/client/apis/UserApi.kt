...
class UserApi(basePath: kotlin.String = defaultBasePath, webClient: WebClient = NettyWebClient(), authHeader: String? = null) : ApiClient(basePath, webClient, authHeader) {
    ...
    */
    fun checkTokenValidityRequestConfig(userId: kotlin.String, token: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/rest/v1/user/token/{userId}".replace("{"+"userId"+"}", "$userId"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    */
    fun getTokenRequestConfig(userId: kotlin.String, key: kotlin.String, tokenValidity: kotlin.Long?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.POST,
            path = "/rest/v1/user/token/{userId}/{key}".replace("{"+"userId"+"}", "$userId").replace("{"+"key"+"}", "$key"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getTokenInGroup(groupId: kotlin.String, userId: kotlin.String, key: kotlin.String, tokenValidity: kotlin.Long?) : kotlin.String?  {
        val localVariableConfig = getTokenInGroupRequestConfig(groupId = groupId, userId = userId, key = key, tokenValidity = tokenValidity)
    ...
    * @return RequestConfig
    */
    fun getTokenInGroupRequestConfig(groupId: kotlin.String, userId: kotlin.String, key: kotlin.String, tokenValidity: kotlin.Long?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (tokenValidity != null) {
        ...
        return RequestConfig(
            method = RequestMethod.POST,
            path = "/rest/v1/user/inGroup/{groupId}/token/{userId}/{key}".replace("{"+"groupId"+"}", "$groupId").replace("{"+"userId"+"}", "$userId").replace("{"+"key"+"}", "$key"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
