...
interface Crypto {
    ...
    suspend fun addNewKeyPairTo(dataOwnerId: String, newPubKey: PublicKey, newPrivateKey: PrivateKey? = null) : DataOwner

    suspend fun addNewKeyPairTo(dataOwner: DataOwner, newPubKey: PublicKey, newPrivateKey: PrivateKey? = null) : DataOwner
}
