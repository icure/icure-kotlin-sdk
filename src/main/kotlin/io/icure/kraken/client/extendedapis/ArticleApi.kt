...
suspend fun ArticleDto.initDelegations(
    user: UserDto,
    config: CryptoConfig<ArticleDto, io.icure.kraken.client.models.ArticleDto>
): ArticleDto {
...
suspend fun CryptoConfig<ArticleDto, io.icure.kraken.client.models.ArticleDto>.encryptArticle(
    myId: String,
    delegations: Set<String>,
    article: ArticleDto
): io.icure.kraken.client.models.ArticleDto {
...
suspend fun CryptoConfig<ArticleDto, io.icure.kraken.client.models.ArticleDto>.decryptArticle(
    myId: String,
    article: io.icure.kraken.client.models.ArticleDto
): ArticleDto {
