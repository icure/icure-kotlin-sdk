...
suspend fun PatientDto.initDelegations(user: UserDto, config: CryptoConfig<PatientDto>): PatientDto {
...
@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.modifyPatient(user: UserDto, patient: PatientDto, config: CryptoConfig<PatientDto>) =
    this.modifyPatient(
        config.encryptPatient(
            user.healthcarePartyId!!,
            (user.autoDelegations["all"] ?: setOf()) + (user.autoDelegations["medicalInformation"] ?: setOf()),
...
@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.bulkCreatePatients(user: UserDto, patientDto: List<PatientDto>, config: CryptoConfig<PatientDto>) : List<IdWithRevDto>? {
...
@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.bulkUpdatePatients(user: UserDto, patientDto: List<PatientDto>, config: CryptoConfig<PatientDto>) : List<IdWithRevDto>? {
...
@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.filterPatientsBy(user: UserDto, filterChainPatient: FilterChainPatient, startKey: String?, startDocumentId: String?, limit: Int?, skip: Int?, sort: String?, desc: Boolean?, config: CryptoConfig<PatientDto>) : PaginatedListPatientDto? {
...
@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.findByAccessLogUserAfterDate(user: UserDto, userId: String, accessType: String?, startDate: Long?, startKey: String?, startDocumentId: String?, limit: Int?, config: CryptoConfig<PatientDto>) : PaginatedListPatientDto? {
...
@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.findByExternalId(user: UserDto, externalId: String, config: CryptoConfig<PatientDto>) : PatientDto? {
    return this.findByExternalId(externalId)?.let { config.decryptPatient(user.healthcarePartyId!!, it) }
}

@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.findByNameBirthSsinAuto(user: UserDto, healthcarePartyId: String?, filterValue: String?, startKey: String?, startDocumentId: String?, limit: Int?, sortDirection: String?, config: CryptoConfig<PatientDto>) : PaginatedListPatientDto? {
...
@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.fuzzySearch(user: UserDto, firstName: String?, lastName: String?, dateOfBirth: Int?, config: CryptoConfig<PatientDto>) : List<PatientDto>? {
    return this.fuzzySearch(firstName, lastName, dateOfBirth)?.map { config.decryptPatient(user.healthcarePartyId!!, it) }
}

@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.getPatient(user: UserDto, patientId: String, config: CryptoConfig<PatientDto>) : PatientDto? {
    return this.getPatient(patientId)?.let { config.decryptPatient(user.healthcarePartyId!!, it) }
}

@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.getPatients(user: UserDto, listOfIdsDto: ListOfIdsDto, config: CryptoConfig<PatientDto>) : List<PatientDto>? {
    return this.getPatients(listOfIdsDto)?.map { config.decryptPatient(user.healthcarePartyId!!, it) }
}
@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.listDeletedPatients(user: UserDto, startDate: Long?, endDate: Long?, desc: Boolean?, startDocumentId: String?, limit: Int?, config: CryptoConfig<PatientDto>) : PaginatedListPatientDto? {
...
@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.listDeletedPatientsByName(user: UserDto, firstName: String?, lastName: String?, config: CryptoConfig<PatientDto>) : List<PatientDto>? {
    return this.listDeletedPatientsByName(firstName, lastName)?.map { config.decryptPatient(user.healthcarePartyId!!, it) }
}
@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.listOfMergesAfter(user: UserDto, date: Long, config: CryptoConfig<PatientDto>) : List<PatientDto>? {
    return this.listOfMergesAfter(date)?.map { config.decryptPatient(user.healthcarePartyId!!, it) }
}
@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.listOfPatientsModifiedAfter(user: UserDto, date: Long, startKey: Long?, startDocumentId: String?, limit: Int?, config: CryptoConfig<PatientDto>) : PaginatedListPatientDto? {
...
@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.listPatients(user: UserDto, hcPartyId: String?, sortField: String?, startKey: String?, startDocumentId: String?, limit: Int?, sortDirection: String?, config: CryptoConfig<PatientDto>) : PaginatedListPatientDto? {
...
@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.listPatientsByHcParty(user: UserDto, hcPartyId: String, sortField: String?, startKey: String?, startDocumentId: String?, limit: Int?, sortDirection: String?, config: CryptoConfig<PatientDto>) : PaginatedListPatientDto? {
...
@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.listPatientsOfHcParty(user: UserDto, hcPartyId: String, sortField: String?, startKey: String?, startDocumentId: String?, limit: Int?, sortDirection: String?, config: CryptoConfig<PatientDto>) : PaginatedListPatientDto? {
...
@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.mergeInto(user: UserDto, toId: String, fromIds: String, config: CryptoConfig<PatientDto>) : PatientDto? {
    return this.mergeInto(toId, fromIds)?.let { config.decryptPatient(user.healthcarePartyId!!, it) }
}

@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.modifyPatientReferral(user: UserDto, patientId: String, referralId: String, start: Long?, end: Long?, config: CryptoConfig<PatientDto>) : PatientDto? {
    return this.modifyPatientReferral(patientId, referralId, start, end)?.let { config.decryptPatient(user.healthcarePartyId!!, it) }
}

@ExperimentalCoroutinesApi
@ExperimentalStdlibApi
suspend fun PatientApi.newPatientDelegations(user: UserDto, patientId: String, delegationDto: List<DelegationDto>, config: CryptoConfig<PatientDto>) : PatientDto? {
