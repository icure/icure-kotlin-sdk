...
suspend fun ReceiptDto.initDelegations(
    user: UserDto,
    config: CryptoConfig<ReceiptDto, io.icure.kraken.client.models.ReceiptDto>
): ReceiptDto {
...
suspend fun CryptoConfig<ReceiptDto, io.icure.kraken.client.models.ReceiptDto>.encryptReceipt(
    myId: String,
    delegations: Set<String>,
    receipt: ReceiptDto
): io.icure.kraken.client.models.ReceiptDto {
...
suspend fun CryptoConfig<ReceiptDto, io.icure.kraken.client.models.ReceiptDto>.decryptReceipt(
    myId: String,
    receipt: io.icure.kraken.client.models.ReceiptDto
): ReceiptDto {
