...
data class CalendarItemDto (
    ...
    @Json(name = "meetingTags")
    val meetingTags: kotlin.collections.List<CalendarItemTagDto>,
    ...
    @Json(name = "masterCalendarItemId")
    ...
    @Json(name = "confirmationTime")
    val confirmationTime: kotlin.Long? = null,
    @Json(name = "confirmationId")
