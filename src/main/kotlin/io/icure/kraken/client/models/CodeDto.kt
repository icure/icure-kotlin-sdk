...
data class CodeDto(
    ...
    enum class Flags(val value: kotlin.String) {
        @JsonProperty(value = "male_only")
        maleOnly("male_only"),

        @JsonProperty(value = "female_only")
        femaleOnly("female_only"),

        @JsonProperty(value = "deptkinesitherapy")
        deptkinesitherapy("deptkinesitherapy"),

        @JsonProperty(value = "deptnursing")
        deptnursing("deptnursing"),

        @JsonProperty(value = "deptgeneralpractice")
        deptgeneralpractice("deptgeneralpractice"),

        @JsonProperty(value = "deptsocialworker")
        deptsocialworker("deptsocialworker"),

        @JsonProperty(value = "deptpsychology")
        deptpsychology("deptpsychology"),

        @JsonProperty(value = "deptadministrative")
        deptadministrative("deptadministrative"),

        @JsonProperty(value = "deptdietetics")
        deptdietetics("deptdietetics"),

        @JsonProperty(value = "deptspeechtherapy")
        deptspeechtherapy("deptspeechtherapy"),

        @JsonProperty(value = "deptdentistry")
        deptdentistry("deptdentistry"),

        @JsonProperty(value = "deptoccupationaltherapy")
        deptoccupationaltherapy("deptoccupationaltherapy"),

        @JsonProperty(value = "depthealthcare")
        depthealthcare("depthealthcare"),

        @JsonProperty(value = "deptgynecology")
        deptgynecology("deptgynecology"),

        @JsonProperty(value = "deptpediatry")
        deptpediatry("deptpediatry"),

        @JsonProperty(value = "deptalgology")
        deptalgology("deptalgology"),

        @JsonProperty(value = "deptanatomopathology")
        deptanatomopathology("deptanatomopathology"),

        @JsonProperty(value = "deptanesthesiology")
        deptanesthesiology("deptanesthesiology"),

        @JsonProperty(value = "deptbacteriology")
        deptbacteriology("deptbacteriology"),

        @JsonProperty(value = "deptcardiacsurgery")
        deptcardiacsurgery("deptcardiacsurgery"),

        @JsonProperty(value = "deptcardiology")
        deptcardiology("deptcardiology"),

        @JsonProperty(value = "deptchildandadolescentpsychiatry")
        deptchildandadolescentpsychiatry("deptchildandadolescentpsychiatry"),

        @JsonProperty(value = "deptdermatology")
        deptdermatology("deptdermatology"),

        @JsonProperty(value = "deptdiabetology")
        deptdiabetology("deptdiabetology"),

        @JsonProperty(value = "deptemergency")
        deptemergency("deptemergency"),

        @JsonProperty(value = "deptendocrinology")
        deptendocrinology("deptendocrinology"),

        @JsonProperty(value = "deptgastroenterology")
        deptgastroenterology("deptgastroenterology"),

        @JsonProperty(value = "deptgenetics")
        deptgenetics("deptgenetics"),

        @JsonProperty(value = "deptgeriatry")
        deptgeriatry("deptgeriatry"),

        @JsonProperty(value = "depthandsurgery")
        depthandsurgery("depthandsurgery"),

        @JsonProperty(value = "depthematology")
        depthematology("depthematology"),

        @JsonProperty(value = "deptinfectiousdisease")
        deptinfectiousdisease("deptinfectiousdisease"),

        @JsonProperty(value = "deptintensivecare")
        deptintensivecare("deptintensivecare"),

        @JsonProperty(value = "deptlaboratory")
        deptlaboratory("deptlaboratory"),

        @JsonProperty(value = "deptmajorburns")
        deptmajorburns("deptmajorburns"),

        @JsonProperty(value = "deptmaxillofacialsurgery")
        deptmaxillofacialsurgery("deptmaxillofacialsurgery"),

        @JsonProperty(value = "deptmedicine")
        deptmedicine("deptmedicine"),

        @JsonProperty(value = "deptmolecularbiology")
        deptmolecularbiology("deptmolecularbiology"),

        @JsonProperty(value = "deptneonatalogy")
        deptneonatalogy("deptneonatalogy"),

        @JsonProperty(value = "deptnephrology")
        deptnephrology("deptnephrology"),

        @JsonProperty(value = "deptneurology")
        deptneurology("deptneurology"),

        @JsonProperty(value = "deptneurosurgery")
        deptneurosurgery("deptneurosurgery"),

        @JsonProperty(value = "deptnte")
        deptnte("deptnte"),

        @JsonProperty(value = "deptnuclear")
        deptnuclear("deptnuclear"),

        @JsonProperty(value = "deptnutritiondietetics")
        deptnutritiondietetics("deptnutritiondietetics"),

        @JsonProperty(value = "deptobstetrics")
        deptobstetrics("deptobstetrics"),

        @JsonProperty(value = "deptoncology")
        deptoncology("deptoncology"),

        @JsonProperty(value = "deptophtalmology")
        deptophtalmology("deptophtalmology"),

        @JsonProperty(value = "deptorthopedy")
        deptorthopedy("deptorthopedy"),

        @JsonProperty(value = "deptpalliativecare")
        deptpalliativecare("deptpalliativecare"),

        @JsonProperty(value = "deptpediatricintensivecare")
        deptpediatricintensivecare("deptpediatricintensivecare"),

        @JsonProperty(value = "deptpediatricsurgery")
        deptpediatricsurgery("deptpediatricsurgery"),

        @JsonProperty(value = "deptpharmacy")
        deptpharmacy("deptpharmacy"),

        @JsonProperty(value = "deptphysicalmedecine")
        deptphysicalmedecine("deptphysicalmedecine"),

        @JsonProperty(value = "deptphysiotherapy")
        deptphysiotherapy("deptphysiotherapy"),

        @JsonProperty(value = "deptplasticandreparatorysurgery")
        deptplasticandreparatorysurgery("deptplasticandreparatorysurgery"),

        @JsonProperty(value = "deptpneumology")
        deptpneumology("deptpneumology"),

        @JsonProperty(value = "deptpodiatry")
        deptpodiatry("deptpodiatry"),

        @JsonProperty(value = "deptpsychiatry")
        deptpsychiatry("deptpsychiatry"),

        @JsonProperty(value = "deptradiology")
        deptradiology("deptradiology"),

        @JsonProperty(value = "deptradiotherapy")
        deptradiotherapy("deptradiotherapy"),

        @JsonProperty(value = "deptrevalidation")
        deptrevalidation("deptrevalidation"),

        @JsonProperty(value = "deptrheumatology")
        deptrheumatology("deptrheumatology"),

        @JsonProperty(value = "deptrhumatology")
        deptrhumatology("deptrhumatology"),

        @JsonProperty(value = "deptsenology")
        deptsenology("deptsenology"),

        @JsonProperty(value = "deptsocialservice")
        deptsocialservice("deptsocialservice"),

        @JsonProperty(value = "deptsportsmedecine")
        deptsportsmedecine("deptsportsmedecine"),

        @JsonProperty(value = "deptstomatology")
        deptstomatology("deptstomatology"),

        @JsonProperty(value = "deptsurgery")
        deptsurgery("deptsurgery"),

        @JsonProperty(value = "deptthoracicsurgery")
        deptthoracicsurgery("deptthoracicsurgery"),

        @JsonProperty(value = "depttoxicology")
        depttoxicology("depttoxicology"),

        @JsonProperty(value = "depttropicalmedecine")
        depttropicalmedecine("depttropicalmedecine"),

        @JsonProperty(value = "depturology")
        depturology("depturology"),

        @JsonProperty(value = "deptvascularsurgery")
        deptvascularsurgery("deptvascularsurgery"),

        @JsonProperty(value = "deptvisceraldigestiveabdominalsurgery")
        deptvisceraldigestiveabdominalsurgery("deptvisceraldigestiveabdominalsurgery"),

        @JsonProperty(value = "depttransplantsurgery")
        depttransplantsurgery("depttransplantsurgery"),

        @JsonProperty(value = "deptpercutaneous")
        deptpercutaneous("deptpercutaneous"),

        @JsonProperty(value = "deptchildbirth")
