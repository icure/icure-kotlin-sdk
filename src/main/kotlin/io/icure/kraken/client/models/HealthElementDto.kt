...
data class HealthElementDto (
    ...
    @Json(name = "plansOfAction")
    val plansOfAction: kotlin.collections.List<PlanOfActionDto>,
    /* List of episodes of occurrences of the healthcare element. */
    @Json(name = "episodes")
    val episodes: kotlin.collections.List<EpisodeDto>,
    /* List of care team members assigned for the healthcare element. */
    @Json(name = "careTeam")
    val careTeam: kotlin.collections.List<CareTeamMemberDto>,
