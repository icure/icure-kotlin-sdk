...
data class InvoiceDto (
    ...
    @Json(name = "invoicingCodes")
    val invoicingCodes: kotlin.collections.List<InvoicingCodeDto>,
    @Json(name = "receipts")
    ...
    @Json(name = "sentMediumType")
    val sentMediumType: InvoiceDto.SentMediumType? = null,
    @Json(name = "interventionType")
    ...
    enum class InvoiceType(val value: kotlin.String) {
        ...
        @Json(name = "mutualfund") mutualfund("mutualfund"),
        @Json(name = "payingagency") payingagency("payingagency"),
        @Json(name = "insurance") insurance("insurance"),
        @Json(name = "efact") efact("efact"),
    ...
    enum class SentMediumType(val value: kotlin.String) {
        @Json(name = "cdrom") cdrom("cdrom"),
        @Json(name = "eattest") eattest("eattest"),
        @Json(name = "efact") efact("efact"),
        @Json(name = "email") email("email"),
        @Json(name = "mediprima") mediprima("mediprima"),
        @Json(name = "paper") paper("paper");
    }
    /**
     * 
    ...
    enum class InterventionType(val value: kotlin.String) {
        ...
        @Json(name = "userfees") userfees("userfees");
    }
    /**
     * Type of payment, ex: cash, wired, insurance, debit card, etc.
