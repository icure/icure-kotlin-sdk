...
data class ReceiptDto (
    ...
    @field:JsonProperty("attachmentIds")
    val attachmentIds: kotlin.collections.Map<kotlin.String, kotlin.String> = mapOf(),

    @field:JsonProperty("references")
    val references: kotlin.collections.List<kotlin.String> = listOf(),
    ...
    @field:JsonProperty("subCategory")
