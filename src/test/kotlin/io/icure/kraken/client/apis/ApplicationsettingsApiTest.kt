...
class ApplicationsettingsApiTest() {
    ...
    fun api(fileName: String) = ApplicationsettingsApi(basePath = "https://kraken.icure.dev", authHeader = fileName.basicAuth())
	...
	fun getApplicationSettingsTest(fileName: String) = runBlocking {
        ...
        val response = api(credentialsFile).getApplicationSettings()
