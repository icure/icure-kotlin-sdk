...
class FormApiTest(private val fileName: String) {
	...
	suspend fun createFormTest(fileName: String) {
		...
		if (formDto as? Collection<*> == null) {
            ...
            if (TestUtils.isAutoRev(fileName, "createForm") && it != null) {
                ...
                val currentRev = api.getForm(id.getter.call(it) as String).rev
        ...
        val response = api.createForm(formDto)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun createFormTemplateTest(fileName: String) {
		...
		if (formTemplateDto as? Collection<*> == null) {
            ...
            if (TestUtils.isAutoRev(fileName, "createFormTemplate") && it != null) {
                val id = it::class.memberProperties.first { it.name == "id" }
                val currentRev = api.getForm(id.getter.call(it) as String).rev
                val rev = FormTemplateDto::class.memberProperties.filterIsInstance<KMutableProperty<*>>().first { it.name == "rev" }
                rev.setter.call(it, currentRev)
                }
			}
		} else {
        ...
        val response = api.createFormTemplate(formTemplateDto)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun createFormsTest(fileName: String) {
        ...
        val response = api.createForms(formDto)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun deleteFormTemplateTest(fileName: String) {
		...
		if (formTemplateId as? Collection<*> == null) {
			...
			val paramAsCollection = formTemplateId as? Collection<DocIdentifier> ?: emptyList<DocIdentifier>() as Collection<DocIdentifier>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "deleteFormTemplate") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.deleteFormTemplate(formTemplateId)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun deleteFormsTest(fileName: String) {
        ...
        val formIds: kotlin.String = TestUtils.getParameter(fileName, "deleteForms.formIds")!!
		if (formIds as? Collection<*> == null) {
			...
			val paramAsCollection = formIds as? Collection<DocIdentifier> ?: emptyList<DocIdentifier>() as Collection<DocIdentifier>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "deleteForms") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.deleteForms(formIds)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun findFormTemplatesTest(fileName: String) {
		if (TestUtils.skipEndpoint(fileName, "findFormTemplates")) {
			assert(true)
			println("Endpoint findFormTemplates skipped")
			return
		}
        val credentialsFile = TestUtils.getCredentialsFile(fileName, "findFormTemplates")
        val loadLayout: kotlin.Boolean = TestUtils.getParameter(fileName, "findFormTemplates.loadLayout")!!
		if (loadLayout as? Collection<*> == null) {
			loadLayout.also {
            if (TestUtils.isAutoRev(fileName, "findFormTemplates") && it != null) {
                val id = it::class.memberProperties.first { it.name == "id" }
                val currentRev = api.getForm(id.getter.call(it) as String).rev
			...
			val paramAsCollection = loadLayout as? Collection<FormTemplateDto> ?: emptyList<FormTemplateDto>() as Collection<FormTemplateDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "findFormTemplates") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.findFormTemplates(loadLayout)

        val testFileName = "FormApi.findFormTemplates"
        val file = File(workingFolder + File.separator + this::class.simpleName + File.separator + fileName, "$testFileName.json")
        try {
            val objectFromFile = objectMapper.readValue(file,  if (response as? kotlin.collections.List<FormTemplateDto>? != null) {
            ...
            assertAreEquals("findFormTemplates", objectFromFile, response)
			println("Comparison successful")
        } catch (e:FileNotFoundException) {
            file.parentFile.mkdirs()
            file.createNewFile()
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun findFormTemplatesBySpecialityTest(fileName: String) {
		if (TestUtils.skipEndpoint(fileName, "findFormTemplatesBySpeciality")) {
			assert(true)
			println("Endpoint findFormTemplatesBySpeciality skipped")
			return
		}
        val credentialsFile = TestUtils.getCredentialsFile(fileName, "findFormTemplatesBySpeciality")
        val specialityCode: kotlin.String = TestUtils.getParameter(fileName, "findFormTemplatesBySpeciality.specialityCode")!!
		if (specialityCode as? Collection<*> == null) {
			specialityCode.also {
            if (TestUtils.isAutoRev(fileName, "findFormTemplatesBySpeciality") && it != null) {
                val id = it::class.memberProperties.first { it.name == "id" }
                val currentRev = api.getForm(id.getter.call(it) as String).rev
                val rev = kotlin.String::class.memberProperties.filterIsInstance<KMutableProperty<*>>().first { it.name == "rev" }
                rev.setter.call(it, currentRev)
			...
			val paramAsCollection = specialityCode as? Collection<FormTemplateDto> ?: emptyList<FormTemplateDto>() as Collection<FormTemplateDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "findFormTemplatesBySpeciality") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val loadLayout: kotlin.Boolean = TestUtils.getParameter(fileName, "findFormTemplatesBySpeciality.loadLayout")!!
		if (loadLayout as? Collection<*> == null) {
			loadLayout.also {
            if (TestUtils.isAutoRev(fileName, "findFormTemplatesBySpeciality") && it != null) {
                val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.findFormTemplatesBySpeciality(specialityCode,loadLayout)

        val testFileName = "FormApi.findFormTemplatesBySpeciality"
        val file = File(workingFolder + File.separator + this::class.simpleName + File.separator + fileName, "$testFileName.json")
        try {
            val objectFromFile = objectMapper.readValue(file,  if (response as? kotlin.collections.List<FormTemplateDto>? != null) {
                if ("kotlin.collections.List<FormTemplateDto>".contains("String>")) {
            ...
            assertAreEquals("findFormTemplatesBySpeciality", objectFromFile, response)
			println("Comparison successful")
        } catch (e:FileNotFoundException) {
            file.parentFile.mkdirs()
            file.createNewFile()
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun findFormsByHCPartyPatientForeignKeysTest(fileName: String) {
		if (TestUtils.skipEndpoint(fileName, "findFormsByHCPartyPatientForeignKeys")) {
			assert(true)
			println("Endpoint findFormsByHCPartyPatientForeignKeys skipped")
			return
		}
        val credentialsFile = TestUtils.getCredentialsFile(fileName, "findFormsByHCPartyPatientForeignKeys")
        val hcPartyId: kotlin.String = TestUtils.getParameter(fileName, "findFormsByHCPartyPatientForeignKeys.hcPartyId")!!
		if (hcPartyId as? Collection<*> == null) {
			hcPartyId.also {
            if (TestUtils.isAutoRev(fileName, "findFormsByHCPartyPatientForeignKeys") && it != null) {
                val id = it::class.memberProperties.first { it.name == "id" }
                val currentRev = api.getForm(id.getter.call(it) as String).rev
                val rev = kotlin.String::class.memberProperties.filterIsInstance<KMutableProperty<*>>().first { it.name == "rev" }
                rev.setter.call(it, currentRev)
			...
			val paramAsCollection = hcPartyId as? Collection<FormDto> ?: emptyList<FormDto>() as Collection<FormDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "findFormsByHCPartyPatientForeignKeys") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val secretFKeys: kotlin.String = TestUtils.getParameter(fileName, "findFormsByHCPartyPatientForeignKeys.secretFKeys")!!
		if (secretFKeys as? Collection<*> == null) {
			...
			val paramAsCollection = secretFKeys as? Collection<FormDto> ?: emptyList<FormDto>() as Collection<FormDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "findFormsByHCPartyPatientForeignKeys") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val healthElementId: kotlin.String = TestUtils.getParameter(fileName, "findFormsByHCPartyPatientForeignKeys.healthElementId")!!
		if (healthElementId as? Collection<*> == null) {
			...
			val paramAsCollection = healthElementId as? Collection<FormDto> ?: emptyList<FormDto>() as Collection<FormDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "findFormsByHCPartyPatientForeignKeys") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val planOfActionId: kotlin.String = TestUtils.getParameter(fileName, "findFormsByHCPartyPatientForeignKeys.planOfActionId")!!
		if (planOfActionId as? Collection<*> == null) {
			...
			val paramAsCollection = planOfActionId as? Collection<FormDto> ?: emptyList<FormDto>() as Collection<FormDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "findFormsByHCPartyPatientForeignKeys") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val formTemplateId: kotlin.String = TestUtils.getParameter(fileName, "findFormsByHCPartyPatientForeignKeys.formTemplateId")!!
		if (formTemplateId as? Collection<*> == null) {
			formTemplateId.also {
            if (TestUtils.isAutoRev(fileName, "findFormsByHCPartyPatientForeignKeys") && it != null) {
                val id = it::class.memberProperties.first { it.name == "id" }
			...
			val paramAsCollection = formTemplateId as? Collection<FormDto> ?: emptyList<FormDto>() as Collection<FormDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "findFormsByHCPartyPatientForeignKeys") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.findFormsByHCPartyPatientForeignKeys(hcPartyId,secretFKeys,healthElementId,planOfActionId,formTemplateId)

        val testFileName = "FormApi.findFormsByHCPartyPatientForeignKeys"
        val file = File(workingFolder + File.separator + this::class.simpleName + File.separator + fileName, "$testFileName.json")
        try {
            val objectFromFile = objectMapper.readValue(file,  if (response as? kotlin.collections.List<FormDto>? != null) {
                if ("kotlin.collections.List<FormDto>".contains("String>")) {
            ...
            assertAreEquals("findFormsByHCPartyPatientForeignKeys", objectFromFile, response)
			println("Comparison successful")
        } catch (e:FileNotFoundException) {
            file.parentFile.mkdirs()
            file.createNewFile()
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun findFormsDelegationsStubsByHCPartyPatientForeignKeysTest(fileName: String) {
		if (TestUtils.skipEndpoint(fileName, "findFormsDelegationsStubsByHCPartyPatientForeignKeys")) {
			assert(true)
			println("Endpoint findFormsDelegationsStubsByHCPartyPatientForeignKeys skipped")
			return
		}
        val credentialsFile = TestUtils.getCredentialsFile(fileName, "findFormsDelegationsStubsByHCPartyPatientForeignKeys")
        val hcPartyId: kotlin.String = TestUtils.getParameter(fileName, "findFormsDelegationsStubsByHCPartyPatientForeignKeys.hcPartyId")!!
		if (hcPartyId as? Collection<*> == null) {
			hcPartyId.also {
            if (TestUtils.isAutoRev(fileName, "findFormsDelegationsStubsByHCPartyPatientForeignKeys") && it != null) {
                val id = it::class.memberProperties.first { it.name == "id" }
                val currentRev = api.getForm(id.getter.call(it) as String).rev
                val rev = kotlin.String::class.memberProperties.filterIsInstance<KMutableProperty<*>>().first { it.name == "rev" }
                rev.setter.call(it, currentRev)
        ...
        val secretFKeys: kotlin.String = TestUtils.getParameter(fileName, "findFormsDelegationsStubsByHCPartyPatientForeignKeys.secretFKeys")!!
		if (secretFKeys as? Collection<*> == null) {
			secretFKeys.also {
            if (TestUtils.isAutoRev(fileName, "findFormsDelegationsStubsByHCPartyPatientForeignKeys") && it != null) {
                val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.findFormsDelegationsStubsByHCPartyPatientForeignKeys(hcPartyId,secretFKeys)

        val testFileName = "FormApi.findFormsDelegationsStubsByHCPartyPatientForeignKeys"
        val file = File(workingFolder + File.separator + this::class.simpleName + File.separator + fileName, "$testFileName.json")
        try {
            ...
            assertAreEquals("findFormsDelegationsStubsByHCPartyPatientForeignKeys", objectFromFile, response)
			println("Comparison successful")
        } catch (e:FileNotFoundException) {
            file.parentFile.mkdirs()
            file.createNewFile()
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun getChildrenFormsTest(fileName: String) {
		...
		if (formId as? Collection<*> == null) {
			...
			val paramAsCollection = formId as? Collection<FormDto> ?: emptyList<FormDto>() as Collection<FormDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "getChildrenForms") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.getChildrenForms(formId,hcPartyId)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun getFormTest(fileName: String) {
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun getFormByLogicalUuidTest(fileName: String) {
		...
		if (logicalUuid as? Collection<*> == null) {
			...
			val paramAsCollection = logicalUuid as? Collection<FormDto> ?: emptyList<FormDto>() as Collection<FormDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "getFormByLogicalUuid") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.getFormByLogicalUuid(logicalUuid)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun getFormByUniqueIdTest(fileName: String) {
		...
		if (uniqueId as? Collection<*> == null) {
			...
			val paramAsCollection = uniqueId as? Collection<FormDto> ?: emptyList<FormDto>() as Collection<FormDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "getFormByUniqueId") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.getFormByUniqueId(uniqueId)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun getFormTemplateTest(fileName: String) {
		...
		if (formTemplateId as? Collection<*> == null) {
			...
			val paramAsCollection = formTemplateId as? Collection<FormTemplateDto> ?: emptyList<FormTemplateDto>() as Collection<FormTemplateDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "getFormTemplate") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.getFormTemplate(formTemplateId)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun getFormTemplatesByGuidTest(fileName: String) {
		...
		if (formTemplateGuid as? Collection<*> == null) {
			...
			val paramAsCollection = formTemplateGuid as? Collection<FormTemplateDto> ?: emptyList<FormTemplateDto>() as Collection<FormTemplateDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "getFormTemplatesByGuid") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.getFormTemplatesByGuid(formTemplateGuid,specialityCode)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun getFormsTest(fileName: String) {
		...
		if (listOfIdsDto as? Collection<*> == null) {
			...
			val paramAsCollection = listOfIdsDto as? Collection<FormDto> ?: emptyList<FormDto>() as Collection<FormDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "getForms") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.getForms(listOfIdsDto)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun getFormsByLogicalUuidTest(fileName: String) {
        ...
        val response = api.getFormsByLogicalUuid(logicalUuid)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun getFormsByUniqueIdTest(fileName: String) {
        ...
        val response = api.getFormsByUniqueId(uniqueId)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun modifyFormTest(fileName: String) {
        ...
        val response = api.modifyForm(formDto)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun modifyFormsTest(fileName: String) {
        ...
        val response = api.modifyForms(formDto)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun newFormDelegationsTest(fileName: String) {
		...
		if (delegationDto as? Collection<*> == null) {
			...
			val paramAsCollection = delegationDto as? Collection<FormDto> ?: emptyList<FormDto>() as Collection<FormDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "newFormDelegations") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.newFormDelegations(formId,delegationDto)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun setFormsDelegationsTest(fileName: String) {
        ...
        val response = api.setFormsDelegations(icureStubDto)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun setTemplateAttachmentMultiTest(fileName: String) {
        ...
        val attachment: kotlin.collections.List<kotlin.ByteArray> = TestUtils.getParameter(fileName, "setTemplateAttachmentMulti.attachment")!!
		if (attachment as? Collection<*> == null) {
			...
			val paramAsCollection = attachment as? Collection<kotlin.String> ?: emptyList<kotlin.String>() as Collection<kotlin.String>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "setTemplateAttachmentMulti") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.setTemplateAttachmentMulti(formTemplateId,attachment)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun updateFormTemplateTest(fileName: String) {
        ...
        val response = api.updateFormTemplate(formTemplateId,formTemplateDto)
