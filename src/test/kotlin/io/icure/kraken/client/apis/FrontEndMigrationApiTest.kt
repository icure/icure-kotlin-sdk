...
class FrontEndMigrationApiTest() {
    ...
    fun api(fileName: String) = FrontEndMigrationApi(basePath = java.lang.System.getProperty("API_URL"), authHeader = fileName.basicAuth())
            ...
            try {
                ...
                try {
                    val objectFromFile = (response as? Flow<ByteBuffer>)?.let { file.readAsFlow() } ?: objectMapper.readValue(
                        file,
                        if (response as? List<FrontEndMigrationDto>? != null) {
