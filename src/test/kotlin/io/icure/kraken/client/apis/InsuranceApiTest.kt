...
class InsuranceApiTest(private val fileName: String) {
	...
	suspend fun createInsuranceTest(fileName: String) {
		...
		if (insuranceDto as? Collection<*> == null) {
            ...
            if (TestUtils.isAutoRev(fileName, "createInsurance") && it != null) {
                ...
                val currentRev = api.getInsurance(id.getter.call(it) as String).rev
                val rev = InsuranceDto::class.memberProperties.filterIsInstance<KMutableProperty<*>>().first { it.name == "rev" }
        ...
        val response = api.createInsurance(insuranceDto)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun deleteInsuranceTest(fileName: String) {
		...
		if (insuranceId as? Collection<*> == null) {
			...
			val paramAsCollection = insuranceId as? Collection<DocIdentifier> ?: emptyList<DocIdentifier>() as Collection<DocIdentifier>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "deleteInsurance") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.deleteInsurance(insuranceId)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun getInsuranceTest(fileName: String) {
		...
		if (insuranceId as? Collection<*> == null) {
			...
			val paramAsCollection = insuranceId as? Collection<InsuranceDto> ?: emptyList<InsuranceDto>() as Collection<InsuranceDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "getInsurance") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.getInsurance(insuranceId)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun getInsurancesTest(fileName: String) {
		...
		if (listOfIdsDto as? Collection<*> == null) {
			...
			val paramAsCollection = listOfIdsDto as? Collection<InsuranceDto> ?: emptyList<InsuranceDto>() as Collection<InsuranceDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "getInsurances") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.getInsurances(listOfIdsDto)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun listInsurancesByCodeTest(fileName: String) {
		...
		if (insuranceCode as? Collection<*> == null) {
			...
			val paramAsCollection = insuranceCode as? Collection<InsuranceDto> ?: emptyList<InsuranceDto>() as Collection<InsuranceDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "listInsurancesByCode") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.listInsurancesByCode(insuranceCode)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun listInsurancesByNameTest(fileName: String) {
		...
		if (insuranceName as? Collection<*> == null) {
			...
			val paramAsCollection = insuranceName as? Collection<InsuranceDto> ?: emptyList<InsuranceDto>() as Collection<InsuranceDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "listInsurancesByName") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.listInsurancesByName(insuranceName)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun modifyInsuranceTest(fileName: String) {
        ...
        val response = api.modifyInsurance(insuranceDto)
