...
class KeywordApiTest(private val fileName: String) {
	...
	suspend fun createKeywordTest(fileName: String) {
		...
		if (keywordDto as? Collection<*> == null) {
            ...
            if (TestUtils.isAutoRev(fileName, "createKeyword") && it != null) {
                ...
                val currentRev = api.getKeyword(id.getter.call(it) as String).rev
                val rev = KeywordDto::class.memberProperties.filterIsInstance<KMutableProperty<*>>().first { it.name == "rev" }
        ...
        val response = api.createKeyword(keywordDto)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun deleteKeywordsTest(fileName: String) {
        ...
        val keywordIds: kotlin.String = TestUtils.getParameter(fileName, "deleteKeywords.keywordIds")!!
		if (keywordIds as? Collection<*> == null) {
			keywordIds.also {
			...
			val paramAsCollection = keywordIds as? Collection<DocIdentifier> ?: emptyList<DocIdentifier>() as Collection<DocIdentifier>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "deleteKeywords") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.deleteKeywords(keywordIds)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun getKeywordTest(fileName: String) {
		...
		if (keywordId as? Collection<*> == null) {
			...
			val paramAsCollection = keywordId as? Collection<KeywordDto> ?: emptyList<KeywordDto>() as Collection<KeywordDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "getKeyword") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.getKeyword(keywordId)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun getKeywordsTest(fileName: String) {
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun getKeywordsByUserTest(fileName: String) {
		...
		if (userId as? Collection<*> == null) {
			...
			val paramAsCollection = userId as? Collection<KeywordDto> ?: emptyList<KeywordDto>() as Collection<KeywordDto>
			paramAsCollection.forEach {
                if (TestUtils.isAutoRev(fileName, "getKeywordsByUser") && it != null) {
                    val id = it::class.memberProperties.first { it.name == "id" }
        ...
        val response = api.getKeywordsByUser(userId)
    ...
    @ParameterizedTest
    @MethodSource("fileNames") // six numbers
	suspend fun modifyKeywordTest(fileName: String) {
        ...
        val response = api.modifyKeyword(keywordDto)
